...
export default function Apt() {
  return (
    <PageContainer
      ...
      subtitle="O coração do Termux. APT instala, remove, atualiza e gerencia todo o software do sistema com comandos simples e poderosos."
      difficulty="iniciante"
      timeToRead="25 min"
    >
      <p>
        O <strong>APT</strong> (Advanced Package Tool) é o gerenciador de pacotes do Termux e de
      ...
      <h2>Os Comandos: apt vs pkg</h2>
      <p>
        Você vai encontrar dois comandos na documentação: <code>apt</code> e <code>pkg</code>.
        O <code>apt</code> é a versão moderna, com saída mais amigável e barra de progresso.
        O <code>pkg</code> é o clássico, mais estável para scripts. Para uso no terminal
      ...
      <AlertBox type="info" title="O que é uma flag (parâmetro)?">
        ...
        Exemplo: <code>pkg install -y nginx</code> — o <code>-y</code> é a flag, o <code>nginx</code>
...
apt list --upgradable`}
      ...
      <AlertBox type="danger" title="Sempre faça pkg update antes de instalar">
        Se você rodar <code>pkg install alguma-coisa</code> sem antes fazer
        <code>pkg update</code>, pode instalar uma versão desatualizada do pacote ou
...
pkg purge apache2 apache2-utils apache2-data`}
      />
