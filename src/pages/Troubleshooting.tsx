  ...
  return (
    ...
    >
      <p>
        ...
        iniciante. Este guia cobre os problemas mais comuns no Termux e como resolvê-los.
      </p>
...
sudo add-apt-repository --remove ppa:nome/ppa`}
      ...
      <CodeBlock
        ...
        code={`# Se o GRUB aparece mas o Termux não inicia:
