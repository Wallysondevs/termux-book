...
const NAVIGATION = [
  {
    ...
    items: [
      ...
      { path: "/historia", label: "História do Termux", icon: History },
      { path: "/filosofia", label: "Filosofia & Open Source", icon: PenTool },
    ],
  },
  {
    ...
    icon: Power,
    items: [
      { path: "/instalacao", label: "Instalar (F-Droid · GitHub)", icon: HardDrive },
      { path: "/primeiros-passos", label: "Primeiros Passos", icon: Clock },
      { path: "/ambiente-grafico", label: "Layout do Teclado & Gestos", icon: Monitor },
      { path: "/localizacao", label: "Idioma & Locale", icon: Globe },
    ],
  },
  {
  ...
  {
    title: "Pacotes (pkg & APT)",
    icon: Package,
    items: [
      { path: "/apt", label: "pkg & apt (Completo)", icon: Package },
      { path: "/dpkg", label: "dpkg no Termux", icon: Package },
      { path: "/ppa", label: "Repositórios Extras (x11, root, game)", icon: Package },
      { path: "/snap-flatpak", label: "Termux:API (sensores, GPS)", icon: Boxes },
      { path: "/appimage", label: "Termux:Boot (auto-start)", icon: Boxes },
      { path: "/codigo-fonte", label: "Compilar no Termux (clang)", icon: Code2 },
    ],
  },
  {
    title: "Storage & Processos",
    icon: Users,
    items: [
      { path: "/usuarios", label: "termux-setup-storage", icon: Users },
  ...
  {
    title: "Kernel & Android",
    icon: Cpu,
    items: [
      { path: "/kernel", label: "Kernel Android", icon: Cpu },
      { path: "/boot", label: "Termux:Boot & Tasker", icon: Rocket },
      { path: "/hardware", label: "Hardware do Celular", icon: Cpu },
    ],
  },
  {
    title: "Redes",
  ...
  {
    title: "Servidores no Celular",
    icon: Server,
    items: [
      { path: "/nginx", label: "Nginx no Termux", icon: Server },
      { path: "/apache", label: "Apache (httpd)", icon: Server },
      { path: "/php", label: "PHP no Termux", icon: Code2 },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/timeshift", label: "Backup do $PREFIX", icon: RotateCcw },
      { path: "/cloud-init", label: "Sync com rclone (Drive, S3)", icon: Cloud },
      { path: "/ansible", label: "Ansible (gerenciar do celular)", icon: Wrench },
    ],
  },
  {
    ...
    icon: Shield,
    items: [
      { path: "/seguranca", label: "Hardening do Termux", icon: Shield },
      { path: "/apparmor", label: "Nmap (Recon)", icon: Shield },
      { path: "/fail2ban", label: "Metasploit no Termux", icon: Shield },
      { path: "/gpg", label: "GPG (Chaves)", icon: Key },
      { path: "/luks", label: "Criptografia (age, openssl)", icon: Lock },
    ],
  },
  {
    title: "GUI & proot-distro",
    icon: Music,
    items: [
      { path: "/multimedia", label: "Multimídia (FFmpeg, yt-dlp)", icon: Music },
