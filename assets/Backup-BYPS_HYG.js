import{j as e}from"./index-BGu3owFd.js";import{P as o,I as n}from"./InfoBox-cbYNoYJG.js";import{T as r,C as s,F as t}from"./Terminal-DeUhEdrB.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function h(){return e.jsxs(o,{title:"Backup com rsync",subtitle:"Estratégias 3-2-1, snapshots incrementais com --link-dest, sincronização remota via SSH e scripts robustos para Termux.",difficulty:"intermediario",timeToRead:"50 min",category:"Backup & Cloud",children:[e.jsx(AlertBox,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"rsync"})," "," — "," ","sincroniza."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"tar"})," "," — "," ","agrupa."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Borg"})," "," — "," ","dedup + cripto."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"3-2-1"})," "," — "," ","3 cópias 2 mídias 1 fora."]})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"rsync"})," é a ferramenta clássica para copiar e sincronizar diretórios no Linux. Diferente de ",e.jsx("code",{children:"cp"}),", ele transfere apenas as ",e.jsx("em",{children:"diferenças"})," ","(delta-transfer algorithm), preserva permissões, datas, links e hard-links, e funciona tanto local quanto remotamente sobre SSH. Já vem instalado no Termux por padrão."]}),e.jsx(r,{title:"wallyson@termux: ~",children:e.jsx(s,{command:"rsync --version | head -3",output:`rsync  version 3.2.7  protocol version 31
