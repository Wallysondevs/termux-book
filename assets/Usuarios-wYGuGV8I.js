import{j as e}from"./index-BGu3owFd.js";import{P as d,I as a}from"./InfoBox-cbYNoYJG.js";import{T as s,C as o,F as r}from"./Terminal-DeUhEdrB.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function m(){return e.jsxs(d,{title:"Usuários, Grupos e sudo",subtitle:"Tudo sobre /etc/passwd, /etc/shadow, /etc/group, useradd/adduser, usermod, passwd, chage, sudoers, PAM e o ecossistema completo de gestão de identidades no Termux 0.118.",difficulty:"intermediario",timeToRead:"55 min",category:"Usuários e Processos",children:[e.jsx(AlertBox,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"useradd"})," "," — "," ","cria."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"passwd"})," "," — "," ","senha."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"groups"})," "," — "," ","listagem."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"/etc/passwd"})," "," — "," ","base."]})]}),e.jsxs("p",{children:["O Linux é um sistema operacional ",e.jsx("strong",{children:"multiusuário"})," e ",e.jsx("strong",{children:"multitarefa"})," desde as suas origens em 1991. Cada arquivo, cada processo, cada conexão de rede está associada a um usuário (UID) e a um grupo (GID), que determinam o que aquele processo pode ou não fazer. Saber gerir usuários no Termux é a habilidade mais fundamental de qualquer sysadmin: sem ela, nada de permissões, nada de sudo, nada de hardening, nada de SSH com restrições. Esta página cobre cada arquivo, cada comando e cada flag importante do ecossistema de identidades no Termux 0.118."]}),e.jsxs("p",{children:["O Termux segue uma filosofia particular dentro do mundo Debian: ",e.jsx("strong",{children:"o usuário root vem bloqueado"})," (sem senha definida, com asterisco no shadow). Você nunca faz login direto como root: o primeiro usuário criado durante a instalação é colocado no grupo ",e.jsx("code",{children:"sudo"})," e usa ",e.jsx("code",{children:"sudo"})," para escalar privilégios. Isso é ótimo para auditoria, mas exige entender muito bem como o sudo funciona."]}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(o,{command:"whoami && id",comment:"Quem sou eu agora? Que UID/GID e grupos secundários?",output:`wallyson
...
└────────────────────────────────────────────────────────── login`}),e.jsxs("p",{children:["Os prefixos ",e.jsx("code",{children:"$id$"})," identificam o algoritmo de hash:"]}),e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Prefixo"}),e.jsx("th",{children:"Algoritmo"}),e.jsx("th",{children:"Status no Termux"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"$1$"})}),e.jsx("td",{children:"MD5"}),e.jsx("td",{children:"obsoleto, jamais use"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"$2a$ $2b$ $2y$"})}),e.jsx("td",{children:"bcrypt"}),e.jsx("td",{children:"aceito mas não default"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"$5$"})}),e.jsx("td",{children:"SHA-256"}),e.jsx("td",{children:"aceito (legacy)"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"$6$"})}),e.jsx("td",{children:"SHA-512"}),e.jsx("td",{children:"default no Termux 20.04 e anteriores"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"$y$"})}),e.jsx("td",{children:"yescrypt"}),e.jsx("td",{children:"default no Termux 0.118+ (mais resistente)"})]})]})]}),e.jsxs(s,{children:[e.jsx(o,{root:!0,command:"awk -F: '{print $1, substr($2,1,3)}' /etc/shadow | head -8",output:`root *
daemon *
bin *
sys *
sync *
...
Número de dias de aviso antes da senha expirar             : 7`})]}),e.jsx("h2",{children:"3. adduser — wrapper interativo (preferido no Termux)"}),e.jsxs("p",{children:[e.jsx("code",{children:"adduser"})," é um script Perl criado pelo Debian que ",e.jsx("strong",{children:"chama"}),e.jsx("code",{children:"useradd"})," mas com defaults sensatos: cria home, copia ",e.jsx("code",{children:"/etc/skel"}),", define bash, pergunta senha e GECOS. ",e.jsx("strong",{children:"É a forma idiomática no Termux"}),"."]}),e.jsx(s,{children:e.jsx(o,{root:!0,command:"adduser carlos",output:`Adding user 'carlos' ...
...
carlos                                     **Nunca logou**`}),e.jsx(o,{root:!0,command:"pkg install finger -y"}),e.jsx(o,{command:"finger wallyson",output:`Login: wallyson                       Name: Wallyson Silva
...
No Plan.`})]}),e.jsx("h2",{children:"10. sudo — o coração do Termux"}),e.jsxs("p",{children:[e.jsx("code",{children:"sudo"})," permite executar comandos como outro usuário (default: root) ",e.jsx("em",{children:"se"})," a política em ",e.jsx("code",{children:"/etc/sudoers"})," permitir. No Termux, todo usuário no grupo",e.jsx("code",{children:"sudo"})," recebe permissão total — graças à linha ",e.jsx("code",{children:"%sudo ALL=(ALL:ALL) ALL"}),"."]}),e.jsxs(s,{children:[e.jsx(o,{command:"sudo -V | head -3",output:`Sudo version 1.9.15p5
Sudoers policy plugin version 1.9.15p5
Sudoers file grammar version 50`}),e.jsx(o,{command:"sudo -l",comment:"O que EU posso rodar com sudo",output:`Os usuários autorizados para wallyson no Termux:
    Os usuários podem rodar os seguintes comandos no Termux:
        (ALL : ALL) ALL`}),e.jsx(o,{command:"sudo -ll",comment:"Forma longa, com origem da regra",output:`Sudoers entry: wallyson no Termux, vindo de /etc/sudoers
    RunAsUsers: ALL
    RunAsGroups: ALL
    Comandos:
...
root@termux:~# `}),e.jsx(o,{root:!0,command:"exit",output:`logout
wallyson@termux:~$ `}),e.jsx(o,{command:"sudo -u postgres psql",comment:"Roda psql como postgres"}),e.jsx(o,{command:"sudo -E env | grep PATH",comment:"-E preserva PATH/LANG do usuário",output:`PATH=/home/wallyson/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
...`})]}),e.jsx("h2",{children:"11. /etc/sudoers e /etc/sudoers.d/"}),e.jsxs("p",{children:["O arquivo principal é ",e.jsx("code",{children:"/etc/sudoers"})," (modo 440, root:root). NUNCA edite com",e.jsx("code",{children:"nano"})," ou ",e.jsx("code",{children:"vim"})," diretamente — use ",e.jsx("code",{children:"visudo"}),", que valida a sintaxe antes de salvar (um erro pode te bloquear permanentemente do sudo)."]}),e.jsxs(s,{children:[e.jsx(o,{root:!0,command:"visudo",comment:"Abre /etc/sudoers no editor configurado (nano por padrão no Termux)"}),e.jsx(o,{root:!0,command:"visudo -c",comment:"Apenas valida",output:`/etc/sudoers: parsed OK
/etc/sudoers.d/README: parsed OK
/etc/sudoers.d/admin: parsed OK`}),e.jsx(o,{root:!0,command:"visudo -f /etc/sudoers.d/devs",comment:"Edita um drop-in (preferido a tocar no sudoers principal)"})]}),e.jsx(r,{path:"/etc/sudoers (trecho relevante no Termux)",children:`# Defaults
Defaults        env_reset
...
# end of pam-auth-update config`})]}),e.jsx("h3",{children:"Forçar política de senhas com pam_pwquality"}),e.jsxs(s,{children:[e.jsx(o,{root:!0,command:"pkg install libpam-pwquality -y"}),e.jsx(o,{root:!0,command:"cat /etc/security/pwquality.conf",output:`# minlen = tamanho mínimo
...
Redigite a nova senha: 
passwd: senha atualizada com sucesso`}),e.jsx(o,{root:!0,command:"passwd -S root",output:"root P 2025-04-09 0 99999 7 -1 (Senha definida, yescrypt.)"})]}),e.jsxs("p",{children:["Para ",e.jsx("strong",{children:"desabilitar"})," de novo (volta ao default Termux):"]}),e.jsx(s,{children:e.jsx(o,{root:!0,command:"passwd -dl root",comment:"-d remove senha, -l bloqueia"})}),e.jsx("h2",{children:"14. /etc/skel — modelo de novo home"}),e.jsxs("p",{children:["Tudo que está em ",e.jsx("code",{children:"/etc/skel"})," é copiado para o home recém-criado de cada novo usuário. Customize aqui dotfiles padrão da sua organização."]}),e.jsxs(s,{children:[e.jsx(o,{command:"ls -la /etc/skel",output:`total 24
