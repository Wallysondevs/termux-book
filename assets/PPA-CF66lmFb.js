import{j as e}from"./index-CbmJLKV7.js";import{P as a}from"./PageContainer-C07HsLrK.js";import{C as o}from"./CodeBlock-hEuZNnwQ.js";import{I as s}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function n(){return e.jsxs(a,{title:"PPA — Repositórios Pessoais",subtitle:"Guia completo de PPAs no Termux: adicionar, remover, gerenciar repositórios de terceiros, segurança e alternativas.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsxs("p",{children:["Os ",e.jsx("strong",{children:"PPAs"})," (Personal Package Archives) são repositórios mantidos pela comunidade no Launchpad, permitindo instalar software que não está nos repositórios oficiais do Termux ou versões mais recentes de pacotes existentes. São a forma mais fácil de obter software atualizado no Termux."]}),e.jsx("h2",{children:"1. Adicionar e Usar PPAs"}),e.jsx(o,{title:"Gerenciar PPAs no Termux",code:`# Adicionar um PPA
  ...
  sudo mv /tmp/ppa-problematico.list /etc/apt/sources.list.d/`}),e.jsxs(s,{type:"warning",title:"PPAs e atualizações do Termux",children:["Ao atualizar o Termux para uma nova versão (ex: 22.04 → 24.04), todos os PPAs são ",e.jsx("strong",{children:"automaticamente desabilitados"}),". Após a atualização, você precisa reativar manualmente cada PPA e verificar se ele suporta a nova versão."]})]})}export{n as default};
