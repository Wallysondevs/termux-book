import{j as e}from"./index-BGu3owFd.js";import{P as s,I as o}from"./InfoBox-cbYNoYJG.js";import{C as a}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(s,{title:"Compilar Código Fonte no Termux",subtitle:"Guia completo para compilar software a partir do código fonte: ./configure, make, make install, checkinstall, dependências e boas práticas.",difficulty:"avancado",timeToRead:"25 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"./configure"})," "," — "," ","Autotools."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"make"})," "," — "," ","compila."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"make install"})," "," — "," ","instala."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"CMake"})," "," — "," ","alternativa moderna."]})]}),e.jsx("p",{children:"Compilar a partir do código fonte permite instalar a versão mais recente de qualquer software, aplicar patches, otimizar para seu hardware e entender como o software é construído. É o método usado quando o pacote não está disponível no apt/snap/flatpak ou quando você precisa de uma versão específica."}),e.jsx("h2",{children:"1. Preparar o Ambiente"}),e.jsx(a,{title:"Instalar ferramentas de compilação",code:`# Instalar o essencial para compilação
  ...
  # Instalar
  sudo cmake --install .
  # Ou: sudo make install`}),e.jsx("h2",{children:"5. Encontrar Dependências"}),e.jsx(a,{title:"Resolver dependências de compilação",code:`# Padrão no Termux: pacotes -dev contêm os headers
  # Se o configure pede "libfoo", instale "libfoo-dev"
  pkg install -y libfoo-dev

  # Dependências comuns:
  pkg install -y     libssl-dev     libcurl4-openssl-dev     libxml2-dev     libsqlite3-dev     libjpeg-dev     libpng-dev     zlib1g-dev     libreadline-dev     libncurses5-dev     libffi-dev
  ...
  pkg files update`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(a,{title:"Problemas comuns ao compilar",code:`# "configure: error: C compiler cannot create executables"
  ...
  # Se não tem uninstall: use o install_manifest.txt ou reinstale com checkinstall`}),e.jsxs(o,{type:"info",title:"Quando compilar vs usar apt/snap/flatpak",children:["Prefira ",e.jsx("strong",{children:"apt"})," (estável, atualizado, testado). Use",e.jsx("strong",{children:"snap/flatpak"})," se precisar de versão mais recente. Compile do fonte apenas se: precisa de uma versão muito específica, precisa de opções de compilação customizadas, ou o software não está empacotado."]})]})}export{c as default};
