import{j as e}from"./index-d-w5ROEn.js";import{P as r}from"./PageContainer-t8f2nTRw.js";import{C as a}from"./CodeBlock-D742nO-w.js";import{I as s}from"./InfoBox-CC8iv9sT.js";import"./house-BxulrXL6.js";import"./proxy-Ap2-YjtX.js";function n(){return e.jsxs(r,{title:"Hardware — Informações e Diagnóstico",subtitle:"Guia completo para identificar hardware no Termux: CPU, memória, discos, placa de vídeo, rede, USB, sensores e drivers.",difficulty:"iniciante",timeToRead:"25 min",children:[e.jsx("p",{children:"O Termux oferece diversas ferramentas para identificar, monitorar e diagnosticar o hardware do seu computador. Saber usar essas ferramentas é essencial para verificar compatibilidade, diagnosticar problemas e otimizar a performance."}),e.jsx("h2",{children:"1. Visão Geral do Sistema"}),e.jsx(a,{title:"Informações gerais do hardware",code:`# Resumo completo do hardware
  sudo lshw -short
  ...
  sudo memtester 1G 1    # Testar 1GB, 1 vez`}),e.jsxs(s,{type:"info",title:"Ferramentas gráficas de hardware",children:["Para uma visão gráfica: ",e.jsx("code",{children:"hardinfo"})," (Informações do Sistema),",e.jsx("code",{children:"gnome-disks"})," (Discos), ",e.jsx("code",{children:"nvidia-settings"})," (GPU NVIDIA). Instale com ",e.jsx("code",{children:"pkg install hardinfo gnome-disk-utility"}),"."]})]})}export{n as default};
