import{j as e}from"./index-BGu3owFd.js";import{P as i,I as o}from"./InfoBox-cbYNoYJG.js";import{C as r}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return e.jsxs(i,{title:"Variáveis de Ambiente",subtitle:"Guia completo de variáveis de ambiente no Termux: PATH, HOME, definir, exportar, persistir, .env e boas práticas de configuração.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"env"})," "," — "," ","lista."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"export"})," "," — "," ","define."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"/etc/environment"})," "," — "," ","globais."]}),e.jsxs("li",{children:[e.jsx("strong",{children:".bashrc"})," "," — "," ","por user."]})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Variáveis de ambiente"})," são valores dinâmicos que afetam o comportamento de processos no sistema. Elas armazenam configurações como caminhos de execução (",e.jsx("code",{children:"PATH"}),"), diretório home (",e.jsx("code",{children:"HOME"}),"), credenciais de APIs e muito mais. Todo programa no Linux herda as variáveis do processo pai."]}),e.jsx("h2",{children:"1. Ver Variáveis de Ambiente"}),e.jsx(r,{title:"Listar e inspecionar variáveis",code:`# Ver todas as variáveis de ambiente
  env
  # Ou: printenv
  ...
  bash -xl 2>&1 | grep MINHA_VAR`}),e.jsxs(o,{type:"warning",title:"Segurança de variáveis",children:["Nunca coloque senhas ou chaves de API diretamente no código ou no",e.jsx("code",{children:".bashrc"}),". Use arquivos ",e.jsx("code",{children:".env"})," (adicionados ao",e.jsx("code",{children:".gitignore"}),") ou gerenciadores de secrets como o",e.jsx("strong",{children:"pass"}),", ",e.jsx("strong",{children:"Vault"})," ou variáveis de CI/CD."]})]})}export{d as default};
