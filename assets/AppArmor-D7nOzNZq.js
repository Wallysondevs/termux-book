import{j as e}from"./index-CbmJLKV7.js";import{P as i}from"./PageContainer-C07HsLrK.js";import{T as o,C as r,F as s}from"./Terminal-BBUvJLoF.js";import{I as a}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function m(){return e.jsxs(i,{title:"AppArmor — MAC do Termux",subtitle:"Mandatory Access Control nativo do Termux: perfis, modos enforce/complain, criação de perfis novos com aa-genprof e comparação com SELinux.",difficulty:"avancado",timeToRead:"25 min",category:"Segurança",children:[e.jsxs("p",{children:["O ",e.jsx("strong",{children:"AppArmor"})," é um ",e.jsx("em",{children:"Mandatory Access Control"})," (MAC) que confina processos a um conjunto explícito de recursos: arquivos, capabilities do kernel, sockets de rede, sinais. Diferente do ",e.jsx("strong",{children:"DAC"})," (permissões rwx + uid/gid) que é discricionário, o MAC é imposto pelo kernel ",e.jsx("em",{children:"mesmo se o processo for root"}),". No Termux o AppArmor vem ligado por padrão e protege serviços como CUPS, snapd, dhclient, evince, firefox (snap), nginx (opcional), apache, mysqld."]}),e.jsxs(o,{title:"wallyson@termux: ~",children:[e.jsx(r,{command:"aa-enabled",output:"Yes"}),e.jsx(r,{command:"cat /sys/kernel/security/apparmor/profiles | head -10",output:`/usr/bin/man (enforce)
...
snap.firefox.firefox (enforce)`})]}),e.jsx("h2",{children:"1. Instalando as ferramentas e estrutura"}),e.jsxs(o,{title:"root@termux: ~",children:[e.jsx(r,{root:!0,command:"pkg install -y apparmor apparmor-utils apparmor-profiles apparmor-profiles-extra",output:`Reading package lists... Done
...
Setting up apparmor-profiles (4.0.1-termux1) ...`}),e.jsx(r,{root:!0,command:"ls /etc/apparmor.d/",output:`abstractions/         tunables/
...
consoles
crypto
cups-client`})]}),e.jsx("h2",{children:"2. aa-status — radiografia do sistema"}),e.jsx(o,{title:"root@termux: ~",children:e.jsx(r,{root:!0,command:"aa-status",output:`apparmor module is loaded.
...
0 processes are unconfined but have a profile defined.`})}),e.jsx(a,{type:"info",title:"Os modos de um perfil",children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"enforce"})," — viola o perfil = ação BLOQUEADA + log no auditd."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"complain"})," — viola o perfil = log apenas (não bloqueia). Modo de aprendizado/teste."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"disable"})," — perfil desativado, processo roda sem MAC."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"kill"})," (raro) — viola o perfil = SIGKILL no processo."]})]})}),e.jsx("h2",{children:"3. Trocar modo de um perfil"}),e.jsxs(o,{title:"root@termux: ~",children:[e.jsx(r,{root:!0,command:"aa-complain /usr/sbin/nginx",output:"Setting /usr/sbin/nginx to complain mode."}),e.jsx(r,{root:!0,command:"aa-enforce /usr/sbin/nginx",output:"Setting /usr/sbin/nginx to enforce mode."}),e.jsx(r,{root:!0,command:"aa-disable /usr/sbin/mysqld",comment:"Cria link em /etc/apparmor.d/disable/",output:"Disabling /usr/sbin/mysqld."}),e.jsx(r,{root:!0,command:"ls /etc/apparmor.d/disable/",output:"usr.sbin.mysqld"}),e.jsx(r,{root:!0,command:"aa-enforce /etc/apparmor.d/usr.sbin.mysqld",comment:"Reabilita removendo o link e aplicando",output:"Setting /etc/apparmor.d/usr.sbin.mysqld to enforce mode."})]}),e.jsx("h2",{children:"4. Anatomia de um perfil"}),e.jsx(s,{path:"/etc/apparmor.d/usr.sbin.tcpdump",children:`# vim:syntax=apparmor
...
Severity: 4
 ...
 [1 - #include <abstractions/nameservice>]
  2 - /etc/passwd r,
(A)llow / [(D)eny] / (I)gnore / (G)lob / Glob with (E)xtension / (N)ew / Audi(t) / (O)wner permissions / Abo(r)t / (F)inish`}),e.jsx(r,{root:!0,command:"# escolha A para aprovar; depois F para terminar"})]}),e.jsx("h2",{children:"7. aa-logprof — refinar perfil já em uso"}),e.jsxs("p",{children:["Quando um perfil em ",e.jsx("em",{children:"complain"})," registra novas violações, ",e.jsx("code",{children:"aa-logprof"}),"lê os logs e propõe regras incrementais."]}),e.jsx(o,{title:"root@termux: ~",children:e.jsx(r,{root:!0,command:"aa-logprof",output:`Reading log entries from /var/log/audit/audit.log.
