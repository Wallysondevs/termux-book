import{j as e}from"./index-BGu3owFd.js";import{P as a,I as o}from"./InfoBox-cbYNoYJG.js";import{C as s}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(a,{title:"Monitoramento de Performance: iostat, top, htop",subtitle:"Guia completo de ferramentas de monitoramento no Termux: CPU, memória, disco, rede e processos em tempo real.",difficulty:"intermediario",timeToRead:"30 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"iostat"})," "," — "," ","I/O stats."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"sar"})," "," — "," ","histórico."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"vmstat"})," "," — "," ","memória."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"mpstat"})," "," — "," ","CPUs."]})]}),e.jsxs("p",{children:["Monitorar a performance do sistema é essencial para identificar gargalos, diagnosticar lentidão e planejar upgrades. O Termux oferece diversas ferramentas para monitorar CPU, memória, disco e rede — desde as básicas como ",e.jsx("strong",{children:"top"})," até as avançadas como ",e.jsx("strong",{children:"iostat"}),", ",e.jsx("strong",{children:"vmstat"})," e ",e.jsx("strong",{children:"sar"}),"."]}),e.jsx("h2",{children:"1. iostat — Monitorar I/O de Disco e CPU"}),e.jsx(s,{title:"Usar o iostat para análise de disco",code:`# Instalar o sysstat (inclui iostat, sar, mpstat, etc.)
