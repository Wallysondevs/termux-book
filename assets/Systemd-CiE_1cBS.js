import{j as e}from"./index-CbmJLKV7.js";import{P as n}from"./PageContainer-C07HsLrK.js";import{T as t,C as s,F as r}from"./Terminal-BBUvJLoF.js";import{I as i}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function u(){return e.jsxs(n,{title:"systemd e systemctl",subtitle:"Init system, gerenciador de serviços e supervisor de processos do Termux — domine units, targets, timers e o ciclo de vida completo.",difficulty:"intermediario",timeToRead:"40 min",category:"Serviços do Sistema",children:[e.jsxs("p",{children:["O ",e.jsx("strong",{children:"systemd"})," é o init (PID 1) do Termux desde a 15.04. Ele substituiu o antigo SysVinit/Upstart e centralizou em um único framework: inicialização do sistema (boot), supervisão de serviços, montagem de filesystems, timers (substituto moderno do cron), sockets, slices/cgroups, logs (journald), resolução DNS (resolved), sincronização de horário (timesyncd), gerenciamento de rede (networkd) e dezenas de outros componentes."]}),e.jsxs("p",{children:["A ferramenta de linha de comando principal é o ",e.jsx("code",{children:"systemctl"})," — com ela você inicia, para, reinicia, habilita, desabilita, mascara e inspeciona qualquer unit (service, socket, timer, target, mount, etc)."]}),e.jsxs(t,{title:"wallyson@termux: ~",children:[e.jsx(s,{command:"systemctl --version",output:`systemd 255 (255.4-termux.4)
...
root@termux:~#`}),e.jsx(s,{root:!0,command:"systemd-run --uid=monitor --gid=monitor /usr/local/bin/site-monitor.sh"})]}),e.jsx("h2",{children:"10. Hostname, locale, timezone via systemd"}),e.jsxs(t,{children:[e.jsx(s,{command:"hostnamectl",output:`   Static hostname: termux
