import{j as e}from"./index-BGu3owFd.js";import{P as a,I as r}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return e.jsxs(a,{title:"Scripts Bash — Automação no Terminal",subtitle:"Guia completo de shell scripting: variáveis, condições, loops, funções, arrays, tratamento de erros, debug e boas práticas.",difficulty:"intermediario",timeToRead:"35 min",children:[e.jsx(r,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"#!/bin/bash"})," "," — "," ","shebang."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Variáveis"})," "," — "," ","VAR=val."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"if/for"})," "," — "," ","controle."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"set -e"})," "," — "," ","aborta erros."]})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Scripts Bash"})," automatizam tarefas repetitivas no terminal. Um script é simplesmente um arquivo de texto com uma sequência de comandos que o Bash executa em ordem. Desde backups automáticos até deploys complexos, scripts são a base da automação em servidores Linux."]}),e.jsx("h2",{children:"1. Primeiro Script"}),e.jsx(o,{title:"Criar e executar scripts Bash",code:`# Criar um script
