import{j as e}from"./index-BGu3owFd.js";import{P as a,I as t}from"./InfoBox-cbYNoYJG.js";import{C as i}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(a,{title:"Git — Controle de Versão",subtitle:"Guia completo do Git no Termux: instalar, configurar, branches, merge, rebase, stash, reset, tags, GitHub e workflows profissionais.",difficulty:"iniciante",timeToRead:"35 min",children:[e.jsx(t,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"git"})," "," — "," ","VCS."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"clone"})," "," — "," ","baixa repo."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"commit"})," "," — "," ","grava."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"push/pull"})," "," — "," ","sincroniza."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Git"})," é o sistema de controle de versão mais usado no mundo. Ele rastreia todas as mudanças no seu código, permite colaborar com outros desenvolvedores, reverter para versões anteriores e trabalhar em múltiplas funcionalidades simultaneamente com branches."]}),e.jsx("h2",{children:"1. Instalação e Configuração"}),e.jsx(i,{title:"Instalar e configurar o Git",code:`# Instalar Git
  pkg install -y git
