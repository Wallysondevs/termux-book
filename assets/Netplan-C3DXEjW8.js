import{j as e}from"./index-d-w5ROEn.js";import{P as a}from"./PageContainer-t8f2nTRw.js";import{T as s,C as r,F as t}from"./Terminal-B39pZIiO.js";import{I as n}from"./InfoBox-CC8iv9sT.js";import"./house-BxulrXL6.js";import"./proxy-Ap2-YjtX.js";function p(){return e.jsxs(a,{title:"Netplan — Configuração de Rede no Termux",subtitle:"O sistema declarativo YAML que controla toda a rede do Termux desde a 17.10. DHCP, IP estático, Wi-Fi, VLAN, bonding, bridges e troubleshooting.",difficulty:"intermediario",timeToRead:"40 min",category:"Redes",children:[e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Netplan"})," é o sistema oficial de configuração de rede do Termux desde a versão 17.10. Em vez de você editar diretamente os arquivos de cada renderer (systemd-networkd ou NetworkManager), você descreve a rede em ",e.jsx("strong",{children:"YAML"})," dentro de ",e.jsx("code",{children:"/etc/netplan/"})," e roda ",e.jsx("code",{children:"netplan apply"})," — o Netplan gera as configurações nativas no backend escolhido. É declarativo, idempotente e portável."]}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{command:"ls /etc/netplan/",output:"50-cloud-init.yaml"}),e.jsx(r,{command:"netplan --version",output:"0.107.1"}),e.jsx(r,{command:"netplan status",output:`     Online state: online
...
`}),e.jsx("h2",{children:"4. DHCP simples (caso mais comum)"}),e.jsx(t,{path:"/etc/netplan/01-dhcp.yaml",children:`network:
  ...
  ethernets:
    enp3s0:
      dhcp4: true
      dhcp6: true
`}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{root:!0,command:"netplan apply"}),e.jsx(r,{command:"ip -br a show enp3s0",output:"enp3s0           UP             192.168.1.100/24 fe80::a00:27ff:fe4b:891c/64"})]}),e.jsx("h2",{children:"5. IP estático completo"}),e.jsx(t,{path:"/etc/netplan/02-static.yaml",children:`network:
  version: 2
  renderer: networkd
  ethernets:
    enp3s0:
...
`}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{root:!0,command:"netplan generate",comment:"Apenas gera configs no /run/, não aplica"}),e.jsx(r,{root:!0,command:"netplan try",comment:"Aplica e reverte em 120s se você não confirmar (Enter)",output:`Do you want to keep these settings?
...
`}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{root:!0,command:"netplan apply"}),e.jsx(r,{command:"ip -br a",output:`lo               UNKNOWN        127.0.0.1/8 ::1/128
enp3s0           UP
...
LIFETIME=86400
DNS=192.168.1.1
HOSTNAME=termux`})]}),e.jsx("h2",{children:"12. Validando YAML"}),e.jsx(s,{title:"wallyson@termux: ~",children:e.jsx(r,{root:!0,command:"netplan generate",comment:"Erro de sintaxe será reportado aqui",output:`** (generate:2148): WARNING **: 14:51:02.412: Permissions for /etc/netplan/01-static.yaml are too open. Netplan configuration should NOT be accessible by others.
Error in network definition /etc/netplan/01-static.yaml line 7 column 14: expected mapping`})}),e.jsxs(n,{type:"danger",title:"YAML é sensível a indentação",children:["Use sempre ",e.jsx("strong",{children:"2 espaços"})," (nunca tab). Cada nível encadeia com 2 espaços a mais. Listas começam com ",e.jsx("code",{children:"- "}),". Erro muito comum: misturar 4 espaços em um lugar e 2 em outro."]}),e.jsx("h2",{children:"13. Trocando o renderer"}),e.jsxs("p",{children:["Se você quer migrar do ",e.jsx("code",{children:"NetworkManager"})," (desktop) para"," ",e.jsx("code",{children:"networkd"})," (servidor) ou vice-versa, basta trocar o"," ",e.jsx("code",{children:"renderer:"})," no YAML."]}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{root:!0,command:"systemctl status systemd-networkd",output:`● systemd-networkd.service - Network Configuration
     Loaded: loaded (/lib/systemd/system/systemd-networkd.service; enabled)
     Active: active (running) since Sat 2025-04-12 13:42:11 -03; 1h 10min ago
       Docs: man:systemd-networkd.service(8)
   Main PID: 421 (systemd-network)
     Status: "Processing requests..."`}),e.jsx(r,{root:!0,command:"systemctl status NetworkManager",output:"Unit NetworkManager.service could not be found."})]}),e.jsx("h2",{children:"14. Troubleshooting"}),e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Sintoma"}),e.jsx("th",{children:"Solução"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:'"netplan apply não fez nada"'}),e.jsxs("td",{children:["Rode ",e.jsx("code",{children:"netplan --debug apply"})," e veja o que está sendo gerado."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Servidor sem rede após apply"}),e.jsxs("td",{children:["Acesse via console; remova/edite o YAML; rode ",e.jsx("code",{children:"netplan apply"}),". Sempre prefira ",e.jsx("code",{children:"netplan try"}),"!"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:'"Could not connect to system bus"'}),e.jsxs("td",{children:[e.jsx("code",{children:"systemctl restart systemd-networkd"})," e cheque ",e.jsx("code",{children:"journalctl -u systemd-networkd -e"}),"."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Cloud-init sobrescreve sua config"}),e.jsxs("td",{children:["Crie ",e.jsx("code",{children:"/etc/cloud/cloud.cfg.d/99-disable-network.cfg"})," ","com ",e.jsx("code",{children:"network: {config: disabled}"}),"."]})]})]})]}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{root:!0,command:"netplan --debug apply",output:`** (generate:3211): DEBUG: 14:55:42.114: Processing input file /etc/netplan/50-cloud-init.yaml..
...
DEBUG:no netplan generated NM configuration exists`}),e.jsx(r,{root:!0,command:"journalctl -u systemd-networkd -n 30 --no-pager",comment:"Logs do networkd",output:`abr 12 14:55:42 termux systemd[1]: Reloading systemd-networkd...
...
abr 12 14:55:42 termux systemd-networkd[421]: Reloaded.`})]}),e.jsx("h2",{children:"15. Caso prático completo: servidor com bridge para libvirt"}),e.jsx(t,{path:"/etc/netplan/99-server.yaml",children:`network:
  version: 2
  renderer: networkd
  ethernets:
    enp3s0:
  ...
  bridges:
    br0:
      ...
      parameters:
        stp: false
        forward-delay: 0
`}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(r,{root:!0,command:"chmod 600 /etc/netplan/99-server.yaml"}),e.jsx(r,{root:!0,command:"netplan try",output:"Configuration accepted."}),e.jsx(r,{command:"ip -br a",output:`lo               UNKNOWN        127.0.0.1/8 ::1/128
enp3s0           UP
