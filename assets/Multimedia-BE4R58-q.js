...
# Janela = X11 = precisa do Termux:X11 ativo + DISPLAY=:0`}),e.jsxs(o,{type:"info",title:"Dica de fluxo",children:["Combine: ",e.jsx("strong",{children:"yt-dlp"})," baixa, ",e.jsx("strong",{children:"FFmpeg"})," corta e converte, ",e.jsx("strong",{children:"termux-media-player"})," reproduz no celular. É um pequeno estúdio multimídia rodando no bolso, sem precisar de PC."]})]})}export{p as default};
