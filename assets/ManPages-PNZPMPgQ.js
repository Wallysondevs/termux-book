import{j as a}from"./index-BGu3owFd.js";import{P as s,I as o}from"./InfoBox-cbYNoYJG.js";import{C as e}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function l(){return a.jsxs(s,{title:"Man Pages — Manuais do Sistema",subtitle:"Guia completo para usar man pages, info, help, tldr e aproveitar a documentação integrada do Linux para aprender qualquer comando.",difficulty:"iniciante",timeToRead:"20 min",children:[a.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),a.jsx("h2",{children:"Glossário rápido"}),a.jsxs("ul",{children:[a.jsxs("li",{children:[a.jsx("strong",{children:"man"})," "," — "," ","manual."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"Seções"})," "," — "," ","1=user 5=files 8=admin."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"apropos"})," "," — "," ","busca."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"info"})," "," — "," ","GNU."]})]}),a.jsxs("p",{children:["As ",a.jsx("strong",{children:"man pages"})," (manual pages) são a documentação oficial de cada comando, função e arquivo de configuração do Linux. É a referência mais completa e confiável — está disponível offline, diretamente no terminal, e cobre absolutamente tudo que o sistema oferece."]}),a.jsx("h2",{children:"1. Usar o man"}),a.jsx(e,{title:"Acessar e navegar nas man pages",code:`# Abrir o manual de um comando
  man ls
  man grep
  man chmod
  man ssh
  ...
  pkg install -y manpages-posix`}),a.jsx("h2",{children:"Troubleshooting"}),a.jsx(e,{title:"Problemas comuns com man pages",code:`# "No manual entry for xxx"
  # Instalar man pages:
