...
dbus-launch --exit-with-session startxfce4 &`}),e.jsx("p",{children:'Bom equilíbrio entre recursos e leveza: tem painel, gerenciador de arquivos, menu de apps e configuração visual. É o que mais "parece um desktop" sem matar a bateria.'}),e.jsx("h2",{children:"2. LXQt (parcial)"}),e.jsxs(i,{type:"warning",title:"Limitações do LXQt no Termux",children:["Algumas peças (lxqt-policykit, lxqt-powermanagement) ",e.jsx("strong",{children:"não funcionam"}),"porque dependem de PolicyKit/UPower do Android. O resto roda, mas espere bugs visuais."]}),e.jsx(o,{title:"Instalar e iniciar LXQt",code:`pkg install -y lxqt openbox

termux-x11 :0 &
export DISPLAY=:0
export XDG_RUNTIME_DIR=$TMPDIR
dbus-launch --exit-with-session startlxqt &`}),e.jsx("h2",{children:"3. i3wm — tiling window manager"}),e.jsx("p",{children:"Se você curte teclado e organização automática de janelas, é a opção mais responsiva. Não é um DE: é só o gerenciador de janelas + barra de status."}),e.jsx(o,{title:"Instalar e iniciar i3",code:`pkg install -y i3 i3status dmenu
...
# Editar config
nano ~/.config/i3/config`}),e.jsx("h2",{children:"4. Openbox — minimalista"}),e.jsx(o,{title:"Instalar e iniciar Openbox",code:`pkg install -y openbox obconf
...
# Configurar visualmente: obconf`}),e.jsx("h2",{children:"5. FVWM — clássico configurável"}),e.jsx(o,{title:"Instalar e iniciar FVWM",code:`pkg install -y fvwm
...
# Procure exemplos em fvwm.org`}),e.jsx("h2",{children:"Compositor, papel de parede e launcher"}),e.jsx("p",{children:'Pra dar uma cara mais "moderna" aos WMs minimalistas, instale extras:'}),e.jsx(o,{title:"Extras opcionais",code:`# Papel de parede
pkg install -y feh
...
# Notificações
pkg install -y dunst`}),e.jsxs(i,{type:"warning",title:"Sem aceleração 3D garantida",children:['Termux:X11 usa renderização via software por padrão. Apps que exigem OpenGL pesado (jogos, vídeo 4K, IDEs Electron) ficarão lentos. Para algo "compositor com sombras" (ex: ',e.jsx("code",{children:"picom"}),") o ganho visual costuma não compensar o gasto de bateria."]}),e.jsx("h2",{children:"Resumo prático"}),e.jsxs("ul",{children:[e.jsxs("li",{children:["Quer um desktop convencional? ",e.jsx("strong",{children:"XFCE4"}),"."]}),e.jsxs("li",{children:["Quer máxima velocidade e fluxo por teclado? ",e.jsx("strong",{children:"i3wm"}),"."]}),e.jsxs("li",{children:['Quer só uma "tela com janelas" minimalista? ',e.jsx("strong",{children:"openbox"}),"."]}),e.jsx("li",{children:"Esqueça KDE, GNOME, MATE, Cinnamon e Budgie no Termux puro."})]})]})}export{c as default};
