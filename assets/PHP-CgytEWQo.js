import{j as e}from"./index-CbmJLKV7.js";import{P as s}from"./PageContainer-C07HsLrK.js";import{C as o}from"./CodeBlock-hEuZNnwQ.js";import{I as a}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function c(){return e.jsxs(s,{title:"PHP no Termux — LAMP & LEMP Stack",subtitle:"Instalação completa do PHP, configuração com Apache (LAMP) e Nginx (LEMP), extensões, PHP-FPM, Composer e deploy de aplicações PHP.",difficulty:"intermediario",timeToRead:"35 min",children:[e.jsxs("p",{children:["O ",e.jsx("strong",{children:"PHP"})," é uma das linguagens mais utilizadas para desenvolvimento web, alimentando mais de 75% dos sites do mundo, incluindo WordPress, Laravel, Drupal e Magento. No Termux, o PHP pode ser configurado com Apache (stack LAMP) ou Nginx (stack LEMP), cada um com vantagens diferentes."]}),e.jsx("h2",{children:"LAMP vs LEMP — Qual Escolher?"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"LAMP"})," (Linux + Apache + MySQL + PHP) — Mais tradicional, configuração mais simples via ",e.jsx("code",{children:".htaccess"}),", ideal para hospedagem compartilhada e WordPress."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"LEMP"}),' (Linux + Nginx + MySQL + PHP) — Mais performático, usa menos memória, melhor para sites de alto tráfego. O "E" vem da pronúncia de Nginx ("Engine-X").']})]}),e.jsxs(a,{type:"info",title:"Qual usar?",children:["Para a maioria dos projetos modernos, o LEMP (Nginx + PHP-FPM) é a melhor escolha. Se você vai rodar WordPress ou precisa de compatibilidade com ",e.jsx("code",{children:".htaccess"}),", o LAMP (Apache) pode ser mais conveniente."]}),e.jsx("h2",{children:"1. Instalar o PHP"}),e.jsx(o,{title:"Instalação básica do PHP",code:`# Atualizar repositórios
  ...
  pkg install -y php-xml php-mbstring php-curl php-zip php-bcmath     php-mysql php-pgsql php-redis php-gd php-intl

  # Extensões para WordPress
  pkg install -y php-mysql php-xml php-mbstring php-curl     php-gd php-zip php-imagick php-intl
  ...
  sudo systemctl restart php8.3-fpm`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(o,{title:"Problemas comuns com PHP no Termux",code:`# Erro: "PHP Fatal error: Allowed memory size exhausted"
