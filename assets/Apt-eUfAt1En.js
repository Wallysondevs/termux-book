import{j as e}from"./index-BGu3owFd.js";import{P as s,I as o}from"./InfoBox-cbYNoYJG.js";import{C as a}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(s,{title:"APT — Gerenciador de Pacotes",subtitle:"O coração do Termux. APT instala, remove, atualiza e gerencia todo o software do sistema com comandos simples e poderosos.",difficulty:"iniciante",timeToRead:"25 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"apt"})," "," — "," ","gerenciador."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"update"})," "," — "," ","atualiza listas."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"upgrade"})," "," — "," ","atualiza pacotes."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"install"})," "," — "," ","instala."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"APT"})," (Advanced Package Tool) é o gerenciador de pacotes do Termux e de todas as distribuições baseadas em Debian. Ele é responsável por instalar, remover e atualizar software, resolvendo dependências automaticamente. Com um único comando, você pode instalar um aplicativo completo com todas as bibliotecas que ele precisa."]}),e.jsx("h2",{children:"Os Comandos: apt vs pkg"}),e.jsxs("p",{children:["Você vai encontrar dois comandos na documentação: ",e.jsx("code",{children:"apt"})," e ",e.jsx("code",{children:"pkg"}),". O ",e.jsx("code",{children:"apt"})," é a versão moderna, com saída mais amigável e barra de progresso. O ",e.jsx("code",{children:"pkg"})," é o clássico, mais estável para scripts. Para uso no terminal do dia a dia, use sempre ",e.jsx("code",{children:"apt"}),"."]}),e.jsxs(o,{type:"info",title:"O que é uma flag (parâmetro)?",children:["Flags são instruções extras passadas a um comando, sempre precedidas por ",e.jsx("code",{children:"-"}),"(flag curta, uma letra) ou ",e.jsx("code",{children:"--"})," (flag longa, palavra completa). Exemplo: ",e.jsx("code",{children:"pkg install -y nginx"})," — o ",e.jsx("code",{children:"-y"})," é a flag, o ",e.jsx("code",{children:"nginx"}),"é o pacote. Flags modificam o comportamento do comando."]}),e.jsx("h2",{children:"1. Atualização do Sistema"}),e.jsx(a,{title:"Manter o sistema atualizado",code:`# PASSO 1: Atualizar a LISTA de pacotes disponíveis
pkg update
...
pkg install --no-install-recommends python3
...
pkg autoclean --dry-run
# --dry-run = "ensaio geral" — mostra o que aconteceria, mas não executa

# Limpeza completa de uma vez:
pkg autoclean -y && pkg clean`}),e.jsx("h2",{children:"6. Repositórios e Sources.list"}),e.jsxs("p",{children:["O APT busca pacotes em ",e.jsx("strong",{children:"repositórios"}),". A lista de repositórios fica em",e.jsx("code",{children:"/etc/apt/sources.list"})," e nos arquivos em ",e.jsx("code",{children:"/etc/apt/sources.list.d/"}),"."]}),e.jsx(a,{title:"Entendendo e gerenciando repositórios",code:`# Ver repositórios configurados:
cat /etc/apt/sources.list

# Formato de uma linha de repositório:
# deb https://packages.termux.dev/apt/termux-main noble main restricted universe multiverse
# ^   ^                                 ^      ^    ^         ^        ^
...
pkg update`}),e.jsx("h2",{children:"7. Repositório de Terceiros (Manual)"}),e.jsx(a,{title:"Adicionar repositório com chave GPG",code:`# Exemplo: Adicionar repositório oficial do VS Code (Microsoft)
...
pkg update
pkg install code`}),e.jsx("h2",{children:"8. Comandos Úteis do dpkg"}),e.jsx(a,{title:"dpkg — o instalador de baixo nível",code:`# dpkg é o programa que de fato instala os .deb. O APT usa o dpkg por baixo.
