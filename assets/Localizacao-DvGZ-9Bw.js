import{j as e}from"./index-BGu3owFd.js";import{P as r,I as a}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function n(){return e.jsxs(r,{title:"Localização, Idioma e Fuso Horário",subtitle:"Configurar idioma do sistema, layout de teclado, fuso horário, formatos de data/moeda e locale no Termux para português brasileiro.",difficulty:"iniciante",timeToRead:"25 min",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"locale"})," "," — "," ","idioma."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"localectl"})," "," — "," ","gerencia."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"LANG"})," "," — "," ","env var."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"UTF-8"})," "," — "," ","encoding moderno."]})]}),e.jsxs("p",{children:["A ",e.jsx("strong",{children:"localização"})," (locale) define como o sistema exibe datas, números, moeda, idioma de menus e mensagens de erro. No Termux, isso é controlado por variáveis de ambiente que seguem o padrão POSIX. Configurar corretamente a localização garante que o sistema funcione em português brasileiro, com formato de data dd/mm/aaaa, moeda R$ e teclado ABNT2."]}),e.jsx("h2",{children:"1. Verificar e Configurar o Locale"}),e.jsx(o,{title:"Gerenciar locale do sistema",code:`# Ver todas as configurações de locale atuais
  locale
  # Saída:
  # LANG=pt_BR.UTF-8
  ...
  pkg install -y hunspell-pt-br    # Corretor ortográfico`}),e.jsxs(a,{type:"info",title:"UTF-8 é essencial",children:["Sempre use locales com ",e.jsx("code",{children:".UTF-8"})," (ex: ",e.jsx("code",{children:"pt_BR.UTF-8"}),"). UTF-8 suporta todos os caracteres do português (ç, ã, é, ü, etc.) e emojis. Locales sem UTF-8 podem causar problemas com acentos e caracteres especiais."]}),e.jsx("h2",{children:"2. Configurar o Fuso Horário"}),e.jsx(o,{title:"Gerenciar fuso horário com timedatectl",code:`# Ver a configuração atual de data/hora
  timedatectl
  # Saída:
...
" 1234567.89
  ...
  LC_ALL=C date                   # Data em formato padrão inglês`}),e.jsx("h2",{children:"5. Configurar Idioma de Aplicativos"}),e.jsx(o,{title:"Instalar e gerenciar idiomas no Termux",code:`# Instalar suporte completo ao português brasileiro
  ...
  pkg install -y language-pack-pt language-pack-gnome-pt
  sudo update-locale LANG=pt_BR.UTF-8
  # Reiniciar`}),e.jsxs(a,{type:"info",title:"Locale para servidores",children:["Em servidores, é comum usar ",e.jsx("code",{children:"en_US.UTF-8"})," como locale padrão, mesmo no Brasil. Isso facilita a pesquisa de mensagens de erro em inglês no Google/Stack Overflow. Defina o fuso horário como ",e.jsx("code",{children:"America/Sao_Paulo"}),"mas mantenha o idioma em inglês."]})]})}export{n as default};
