import{j as e}from"./index-d-w5ROEn.js";import{P as t}from"./PageContainer-t8f2nTRw.js";import{T as s,C as o,F as n}from"./Terminal-B39pZIiO.js";import{I as r}from"./InfoBox-CC8iv9sT.js";import"./house-BxulrXL6.js";import"./proxy-Ap2-YjtX.js";function p(){return e.jsxs(t,{title:"Docker Compose",subtitle:"Orquestre stacks multi-container com um único arquivo YAML — networks, volumes, healthchecks, dependências e variáveis de ambiente declarativas.",difficulty:"intermediario",timeToRead:"50 min",category:"Containers",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Docker Compose v2"})," é hoje um ",e.jsx("em",{children:"plugin"})," do CLI do Docker (não mais o binário Python ",e.jsx("code",{children:"docker-compose"}),"). No Termux, ele vem no pacote"," ",e.jsx("code",{children:"docker-compose-plugin"}),", instalado junto com o Docker Engine pelo repositório oficial. O comando passou de ",e.jsx("code",{children:"docker-compose"})," (com hífen) para"," ",e.jsx("code",{children:"docker compose"})," (com espaço)."]}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(o,{command:"docker compose version",output:"Docker Compose version v2.29.7"}),e.jsx(o,{comment:"Confere se o plugin está instalado",command:"dpkg -l docker-compose-plugin",output:`||/ Name                 Versão                       Arquitetura  Descrição
+++-====================-============================-============-===============================
ii  docker-compose-plugin 2.29.7-1~termux.24.04~noble  amd64        Docker Compose (V2) plugin for the Docker CLI`})]}),e.jsxs(r,{type:"warning",title:"Compose v1 está descontinuado",children:["Se você ainda tem ",e.jsx("code",{children:"docker-compose"})," (Python, com hífen), remova:"," ",e.jsx("code",{children:"pkg uninstall docker-compose"}),". A sintaxe e flags evoluíram — use sempre"," ",e.jsx("code",{children:"docker compose"}),"."]}),e.jsx("h2",{children:"Estrutura de um docker-compose.yml"}),e.jsxs("p",{children:["O arquivo descreve a stack inteira: serviços, redes, volumes, segredos. Não precisa mais da chave ",e.jsx("code",{children:"version:"})," (Compose Spec ignora). Cada ",e.jsx("em",{children:"serviço"})," vira um container; o nome do serviço também é o hostname acessível pelos outros serviços."]}),e.jsx(n,{path:"docker-compose.yml",children:`name: meublog
...
TAG=1.27-alpine`}),e.jsx("h2",{children:"Comandos do dia-a-dia"}),e.jsxs(s,{title:"wallyson@termux: ~/meublog",children:[e.jsx(o,{comment:"Sobe a stack inteira em background",command:"docker compose up -d",output:`[+] Running 4/4
...
}`}),e.jsxs(s,{title:"wallyson@termux: ~/meublog",children:[e.jsx(o,{command:"docker compose up -d --wait",output:`[+] Running 4/4
