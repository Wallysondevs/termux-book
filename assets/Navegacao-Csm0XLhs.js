...
# joao@termux:~$ cd /etc
# joao@termux:/etc$    ← você está em /etc`}),o.jsx("h2",{children:"ls — Listar Conteúdo do Diretório"}),o.jsx(e,{title:"Todas as flags do ls explicadas",code:`# Listar o diretório atual (apenas nomes)
ls
