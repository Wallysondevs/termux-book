import{j as e}from"./index-BGu3owFd.js";import{P as a,I as s}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(a,{title:"PPA — Repositórios Pessoais",subtitle:"Guia completo de PPAs no Termux: adicionar, remover, gerenciar repositórios de terceiros, segurança e alternativas.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"PPA"})," "," — "," ","Personal Package Archive."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"add-apt-repository"})," "," — "," ","adiciona."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Launchpad"})," "," — "," ","hospedagem."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Cuidado"})," "," — "," ","source não oficial."]})]}),e.jsxs("p",{children:["Os ",e.jsx("strong",{children:"PPAs"})," (Personal Package Archives) são repositórios mantidos pela comunidade no Launchpad, permitindo instalar software que não está nos repositórios oficiais do Termux ou versões mais recentes de pacotes existentes. São a forma mais fácil de obter software atualizado no Termux."]}),e.jsx("h2",{children:"1. Adicionar e Usar PPAs"}),e.jsx(o,{title:"Gerenciar PPAs no Termux",code:`# Adicionar um PPA
  ...
  pkg update`}),e.jsx("h2",{children:"4. Segurança com PPAs"}),e.jsx(o,{title:"Boas práticas de segurança",code:`# PPAs são mantidos por QUALQUER PESSOA — não são verificados pela Termux Project
  # Boas práticas:
  ...
  sudo mv /tmp/ppa-problematico.list /etc/apt/sources.list.d/`}),e.jsxs(s,{type:"warning",title:"PPAs e atualizações do Termux",children:["Ao atualizar o Termux para uma nova versão (ex: 22.04 → 24.04), todos os PPAs são ",e.jsx("strong",{children:"automaticamente desabilitados"}),". Após a atualização, você precisa reativar manualmente cada PPA e verificar se ele suporta a nova versão."]})]})}export{c as default};
