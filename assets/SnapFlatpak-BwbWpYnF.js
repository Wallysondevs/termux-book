import{j as a}from"./index-d-w5ROEn.js";import{P as o}from"./PageContainer-t8f2nTRw.js";import{C as s}from"./CodeBlock-D742nO-w.js";import{I as e}from"./InfoBox-CC8iv9sT.js";import"./house-BxulrXL6.js";import"./proxy-Ap2-YjtX.js";function d(){return a.jsxs(o,{title:"Snap & Flatpak",subtitle:"Instalando aplicativos via Snap Store e Flathub — entenda os formatos universais de pacotes e suas diferenças.",difficulty:"iniciante",timeToRead:"15 min",children:[a.jsxs("p",{children:["Além do APT (para pacotes .deb), o Termux suporta dois formatos modernos de distribuição de aplicativos: ",a.jsx("strong",{children:"Snap"})," (criado pela Termux Project) e ",a.jsx("strong",{children:"Flatpak"}),"(criado pelo projeto freedesktop.org). Ambos instalam aplicativos de forma isolada do sistema, com todas as dependências embutidas."]}),a.jsx("h2",{children:"Snap: O Formato da Termux Project"}),a.jsx("p",{children:"Snaps são pacotes que incluem o aplicativo e todas as suas dependências. São atualizados automaticamente e funcionam em qualquer distribuição Linux que tenha o snapd instalado."}),a.jsx("h3",{children:"Comandos Essenciais do Snap"}),a.jsx(s,{title:"Gerenciando snaps",code:`# Buscar um snap
snap find firefox
snap find spotify
