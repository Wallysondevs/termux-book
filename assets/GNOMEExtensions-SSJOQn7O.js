...
termux-reload-settings`}),e.jsxs("p",{children:["Vários esquemas prontos (Solarized, Nord, Gruvbox, Tokyo Night, Catppuccin) estão em",e.jsx("a",{href:"https://github.com/Mayccoll/Gogh",children:" Gogh"})," e",e.jsx("a",{href:"https://github.com/storm119/Tilix-Themes",children:" Tilix-Themes"})," — basta copiar para",e.jsx("code",{children:"~/.termux/colors.properties"}),"."]}),e.jsx("h2",{children:"2. Termux:Styling — App de temas prontos"}),e.jsx(o,{title:"Instalar e aplicar",code:`# 1. Instale "Termux:Styling" pelo F-Droid
# 2. Toque longo no terminal -> "More" -> "Style"
# 3. Escolha um esquema de cores e/ou uma fonte
# Aplica direto em ~/.termux/colors.properties e ~/.termux/font.ttf`}),e.jsx("h2",{children:"3. Fontes — ~/.termux/font.ttf"}),e.jsxs("p",{children:["O Termux usa um único arquivo de fonte: ",e.jsx("code",{children:"~/.termux/font.ttf"}),". Para um prompt com ícones (Powerline, Nerd Fonts), baixe uma ",e.jsx("strong",{children:"Nerd Font"}),"."]}),e.jsx(o,{title:"Instalar uma Nerd Font (ex: JetBrainsMono)",code:`mkdir -p ~/.termux
curl -L -o ~/.termux/font.ttf \\
  https://github.com/ryanoasis/nerd-fonts/raw/master/patched-fonts/JetBrainsMono/Ligatures/Regular/JetBrainsMonoNerdFont-Regular.ttf

termux-reload-settings`}),e.jsx("h2",{children:"4. Prompt customizado no bash"}),e.jsx(o,{title:"~/.bashrc — prompt colorido com git",code:`# Adicione ao final do ~/.bashrc
...
# Recarregue:
source ~/.bashrc`}),e.jsx("h2",{children:"5. Zsh + Oh My Zsh"}),e.jsx(o,{title:"Instalar Zsh e Oh My Zsh",code:`pkg install zsh git curl
...
# plugins=(git zsh-autosuggestions zsh-syntax-highlighting)`}),e.jsx("h2",{children:"6. Tema Powerlevel10k"}),e.jsx("p",{children:"Tema rápido, configurável e que aproveita Nerd Fonts."}),e.jsx(o,{title:"Instalar Powerlevel10k",code:`git clone --depth=1 https://github.com/romkatv/powerlevel10k.git \\
...
exec zsh`}),e.jsx("h2",{children:"7. Starship — prompt cross-shell"}),e.jsx("p",{children:"Alternativa moderna escrita em Rust, funciona em bash, zsh, fish."}),e.jsx(o,{title:"Instalar Starship",code:`pkg install starship
...
mkdir -p ~/.config
starship preset nerd-font-symbols -o ~/.config/starship.toml`}),e.jsx("h2",{children:"8. Outras configurações úteis"}),e.jsx(o,{title:"~/.termux/termux.properties",code:`# Tecla Extra Keys customizada
