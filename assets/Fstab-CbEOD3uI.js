...
fsck /dev/sdb1                  | não acessível (block device protegido)`}),e.jsxs(r,{type:"info",title:"Em uma frase",children:["No Android, storage é “monte automático e ponto”. O Termux participa via"," ",e.jsx("code",{children:"termux-setup-storage"})," e via FUSE (",e.jsx("code",{children:"sshfs"}),","," ",e.jsx("code",{children:"gocryptfs"}),"). Editar fstab não é uma opção — nem é necessário."]})]})}export{m as default};
