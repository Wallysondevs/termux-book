import{j as o}from"./index-BGu3owFd.js";import{P as a,I as s}from"./InfoBox-cbYNoYJG.js";import{C as e}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return o.jsxs(a,{title:"Comandos Avançados",subtitle:"awk, sed, find avançado, xargs, cut, tr, jq — processamento de texto e automação de alto nível no terminal.",difficulty:"avancado",timeToRead:"35 min",children:[o.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"Tuning"})," "," — "," ","ajustes avançados."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"sysctl"})," "," — "," ","parâmetros do kernel."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"cgroups"})," "," — "," ","grupos de recursos."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"namespaces"})," "," — "," ","isolamento."]})]}),o.jsxs("p",{children:["Com o domínio dos comandos básicos, é hora de conhecer as ferramentas que separam usuários avançados de iniciantes. ",o.jsx("code",{children:"awk"})," e ",o.jsx("code",{children:"sed"})," são linguagens de processamento de texto poderosas. Combinados com pipes, transformam o terminal em um ambiente de processamento de dados extremamente eficiente."]}),o.jsx("h2",{children:"sed — Editor de Fluxo de Texto"}),o.jsxs("p",{children:["O ",o.jsx("code",{children:"sed"})," (Stream EDitor) processa texto linha por linha, aplicando transformações como substituição, exclusão e inserção."]}),o.jsx(e,{title:"sed: substituição e edição de texto",code:`# Substituição básica (primeira ocorrência por linha)
...
ps aux | awk 'NR>1 {sum += $3} END {print "Média CPU:", sum/NR "%"}'`}),o.jsx("h2",{children:"cut — Extrair Campos de Texto"}),o.jsx(e,{title:"cut: extração de colunas",code:`# Extrair por posição de caractere (1-indexed)
...
ls /etc | grep "\\." | rev | cut -d. -f1 | rev | sort | uniq`}),o.jsx("h2",{children:"tr — Transliterar e Transformar"}),o.jsx(e,{title:"tr: transformando caracteres",code:`# Converter letras minúsculas para maiúsculas
...
'`}),o.jsx("h2",{children:"find Avançado"}),o.jsx(e,{title:"find com critérios complexos",code:`# Encontrar e executar ação (delete sem confirmação — CUIDADO!)
...
find /var/log -name "*.log" -print0 | xargs -0 gzip`}),o.jsx("h2",{children:"sort, uniq e Processamento de Dados"}),o.jsx(e,{title:"Processamento avançado de dados",code:`# Ordenar por múltiplas colunas
...
join -t: -1 1 -2 3 arquivo1.txt arquivo2.txt`}),o.jsx("h2",{children:"jq — Processamento de JSON"}),o.jsx(e,{title:"Processar JSON na linha de comando",code:`# Instalar jq
pkg install jq
...
curl -s https://jsonplaceholder.typicode.com/users | \\
    jq -r '.[] | [.name, .email, .company.name] | @csv'`})]})}export{c as default};
