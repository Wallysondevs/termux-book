import{j as o}from"./index-BGu3owFd.js";import{P as s,I as a}from"./InfoBox-cbYNoYJG.js";import{C as e}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return o.jsxs(s,{title:"Expansões do Bash",subtitle:"Guia completo de expansões do shell Bash: variáveis, chaves, til, aritmética, command substitution, globbing e manipulação de strings.",difficulty:"intermediario",timeToRead:"25 min",children:[o.jsx(a,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"{a,b,c}"})," "," — "," ","brace."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"~"})," "," — "," ","home."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"$(cmd)"})," "," — "," ","command sub."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"*"})," "," — "," ","glob."]})]}),o.jsxs("p",{children:["As ",o.jsx("strong",{children:"expansões do Bash"})," são mecanismos que transformam o texto que você digita antes de o comando ser executado. Dominar as expansões permite escrever comandos mais curtos, poderosos e elegantes — desde renomear dezenas de arquivos em uma linha até fazer cálculos e manipular strings diretamente no terminal."]}),o.jsx("h2",{children:"1. Expansão de Chaves (Brace Expansion)"}),o.jsx(e,{title:"Gerar sequências e combinações com {}",code:`# Expansão de listas
  echo {a,b,c}
  # Saída: a b c
