import{j as e}from"./index-BGu3owFd.js";import{P as r,I as s}from"./InfoBox-cbYNoYJG.js";import{C as i}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return e.jsxs(r,{title:"Termux como Cliente de Cloud (no lugar de Cloud-Init)",subtitle:"O Termux não usa cloud-init, mas pode ser o seu console portátil para provisionar e gerenciar VMs em AWS, GCP, DigitalOcean, etc.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"cloud-init"})," "," — "," ","primeira inicialização."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"user-data"})," "," — "," ","config."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"meta-data"})," "," — "," ","identidade."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Cloud images"})," "," — "," ","pré-prontas."]})]}),e.jsxs(s,{type:"info",title:"Esta página foi reescrita",children:["O ",e.jsx("strong",{children:"cloud-init"})," é a ferramenta que roda DENTRO de uma VM cloud na primeira inicialização (configura usuários, hostname, SSH, pacotes). O Termux roda em Android, não é uma VM cloud, e nunca recebe cloud-init. O que faz sentido é o contrário: usar o Termux como ",e.jsx("strong",{children:"cliente"})," que provisiona e configura VMs cloud via SSH, Terraform, Ansible, ou as APIs/CLIs dos provedores."]}),e.jsx("h2",{children:"Setup inicial no Termux"}),e.jsx(i,{title:"Pacotes essenciais",code:`pkg update && pkg upgrade -y
