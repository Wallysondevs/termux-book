import{j as e}from"./index-CsDtDb2_.js";import{P as a}from"./PageContainer-DdYPssra.js";import{C as t}from"./CodeBlock-CCueYP-d.js";import{I as s}from"./InfoBox-CFJp2Xi7.js";import"./house-BVOOG_Vc.js";import"./proxy-BaSd2E5R.js";function d(){return e.jsxs(a,{title:"Python no Ubuntu",subtitle:"Gerenciar versões do Python, pip, venv, pyenv, instalar pacotes, criar projetos e boas práticas de desenvolvimento Python no Ubuntu.",difficulty:"iniciante",timeToRead:"30 min",children:[e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Python"})," já vem pré-instalado no Ubuntu (é usado internamente pelo sistema). No entanto, é importante saber gerenciar versões, ambientes virtuais e pacotes para desenvolvimento sem conflitar com o Python do sistema."]}),e.jsx("h2",{children:"1. Python no Ubuntu"}),e.jsx(t,{title:"Verificar e instalar Python",code:`# Verificar versão instalada
  python3 --version
