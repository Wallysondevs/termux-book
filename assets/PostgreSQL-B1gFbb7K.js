import{j as s}from"./index-CbmJLKV7.js";import{P as o}from"./PageContainer-C07HsLrK.js";import{C as e}from"./CodeBlock-hEuZNnwQ.js";import{I as a}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function c(){return s.jsxs(o,{title:"PostgreSQL no Termux",subtitle:"Instalação, configuração, gerenciamento de bancos, usuários, backup, replicação, tunning de performance e segurança do PostgreSQL.",difficulty:"intermediario",timeToRead:"35 min",children:[s.jsxs("p",{children:["O ",s.jsx("strong",{children:"PostgreSQL"})," é o banco de dados relacional open source mais avançado do mundo. Suporta JSON, full-text search, tipos geoespaciais (PostGIS), replicação, particionamento e extensibilidade via extensões. É usado por empresas como Apple, Instagram, Spotify e o governo brasileiro."]}),s.jsx("h2",{children:"1. Instalação"}),s.jsx(e,{title:"Instalar o PostgreSQL no Termux",code:`# Instalar o PostgreSQL (versão dos repositórios do Termux)
  ...
  pkg update
  pkg install -y postgresql-16`}),s.jsx("h2",{children:"2. Acessar e Gerenciar o PostgreSQL"}),s.jsx(e,{title:"Comandos básicos do psql",code:`# O PostgreSQL cria um usuário de sistema "postgres" durante a instalação
