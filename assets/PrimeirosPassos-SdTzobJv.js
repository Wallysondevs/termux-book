import{j as e}from"./index-CbmJLKV7.js";import{P as o}from"./PageContainer-C07HsLrK.js";import{C as a}from"./CodeBlock-hEuZNnwQ.js";import{I as i}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function l(){return e.jsxs(o,{title:"Primeiros Passos Pós-Instalação",subtitle:"Acabou de instalar o Termux? Configure drivers, repositórios, idioma e aplicativos essenciais para ter um sistema completo.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsx("p",{children:"Parabéns pela instalação! O Termux já vem bastante completo, mas há algumas configurações importantes a fazer logo após a primeira inicialização. Siga estes passos em ordem para garantir um sistema atualizado, com todos os drivers corretos e as ferramentas que você vai usar no dia a dia."}),e.jsx("h2",{children:"1. Atualizar o Sistema Completamente"}),e.jsx("p",{children:"A primeira coisa sempre é atualizar — a ISO que você usou para instalar pode ter algumas semanas de atraso. Garanta que tudo está na versão mais recente:"}),e.jsx(a,{title:"Atualização completa do sistema",code:`# Atualizar a lista de pacotes disponíveis
pkg update
