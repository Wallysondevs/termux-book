import{j as e}from"./index-BGu3owFd.js";import{P as s,I as o}from"./InfoBox-cbYNoYJG.js";import{C as a}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function p(){return e.jsxs(s,{title:"LUKS — Criptografia de Disco no Termux",subtitle:"Guia completo de criptografia de disco com LUKS: criptografar partições, HDs externos, pendrives, gerenciar chaves e recuperação.",difficulty:"avancado",timeToRead:"30 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"LUKS"})," "," — "," ","full-disk crypto."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"cryptsetup"})," "," — "," ","CLI."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Passphrase"})," "," — "," ","senha."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"/etc/crypttab"})," "," — "," ","boot."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"LUKS"})," (Linux Unified Key Setup) é o padrão de criptografia de disco no Linux. Ele protege seus dados criptografando partições inteiras — se alguém roubar seu notebook ou HD, não consegue ler absolutamente nada sem a senha. O LUKS usa AES-256 por padrão, o mesmo algoritmo usado por governos e militares."]}),e.jsx("h2",{children:"Quando Usar LUKS?"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Notebook/laptop"})," — Se for roubado, seus dados ficam protegidos"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"HD externo/pendrive"})," — Dados sensíveis em mídia portátil"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Servidores"})," — Proteção de dados em repouso (at rest)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Compliance"})," — Exigência de regulamentos como LGPD, GDPR, HIPAA"]})]}),e.jsxs(o,{type:"danger",title:"Backup antes de criptografar",children:["A criptografia de uma partição existente ",e.jsx("strong",{children:"apaga todos os dados"}),". Sempre faça backup completo antes de criptografar. Se você perder a senha e as chaves de recuperação, os dados são irrecuperáveis."]}),e.jsx("h2",{children:"1. Criptografar uma Partição com LUKS"}),e.jsx(a,{title:"Criar partição criptografada",code:`# Instalar ferramentas de criptografia
  ...
  sudo resize2fs /dev/mapper/dados`})]})}export{p as default};
