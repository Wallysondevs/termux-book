import{j as e}from"./index-BGu3owFd.js";import{P as i,I as s}from"./InfoBox-cbYNoYJG.js";import{C as a}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function l(){return e.jsxs(i,{title:"Primeiros Passos Pós-Instalação",subtitle:"Acabou de instalar o Termux? Configure drivers, repositórios, idioma e aplicativos essenciais para ter um sistema completo.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Terminal"})," "," — "," ","interface CLI."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Shell"})," "," — "," ","Bash padrão."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"sudo"})," "," — "," ","root temp."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Prompt"})," "," — "," ","user@host."]})]}),e.jsx("p",{children:"Parabéns pela instalação! O Termux já vem bastante completo, mas há algumas configurações importantes a fazer logo após a primeira inicialização. Siga estes passos em ordem para garantir um sistema atualizado, com todos os drivers corretos e as ferramentas que você vai usar no dia a dia."}),e.jsx("h2",{children:"1. Atualizar o Sistema Completamente"}),e.jsx("p",{children:"A primeira coisa sempre é atualizar — a ISO que você usou para instalar pode ter algumas semanas de atraso. Garanta que tudo está na versão mais recente:"}),e.jsx(a,{title:"Atualização completa do sistema",code:`# Atualizar a lista de pacotes disponíveis
pkg update
...
# Usa apt clean (sem "auto") para apagar o cache inteiro.`}),e.jsxs(s,{type:"info",title:"pkg update vs pkg upgrade",children:[e.jsx("code",{children:"pkg update"})," apenas atualiza a ",e.jsx("em",{children:"lista"})," de pacotes disponíveis (como verificar se há atualizações). Não instala nada. ",e.jsx("code",{children:"pkg upgrade"})," de fato instala as atualizações. Sempre faça os dois juntos."]}),e.jsx("h2",{children:"2. Instalar Drivers de Hardware"}),e.jsx("h3",{children:"Driver NVIDIA (GPU dedicada)"}),e.jsx(a,{title:"Instalar drivers NVIDIA recomendados",code:`# Verificar se tem GPU NVIDIA conectada
lspci | grep -i nvidia
...
# necessário para reproduzir a maioria dos vídeos e músicas`}),e.jsx(s,{type:"info",title:"O que são esses repositórios?",children:e.jsxs("ul",{className:"mt-1 mb-0",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"main"}),": Pacotes livres suportados oficialmente pela Termux Project (já ativo por padrão)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"universe"}),": Pacotes livres mantidos pela comunidade (sem garantia de suporte)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"restricted"}),": Drivers proprietários necessários para hardware específico"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"multiverse"}),": Software com restrições de uso (copyright, patentes)"]})]})}),e.jsx("h2",{children:"6. Configurar o Firewall (UFW)"}),e.jsx(a,{title:"Configuração básica do UFW",code:`# O UFW já vem instalado no Termux. Verificar status:
sudo ufw status
...
# APT::Periodic::Unattended-Upgrade "1";    ← instalar atualizações de segurança`}),e.jsx("h2",{children:"8. Instalar Aplicativos do Dia a Dia"}),e.jsx(a,{title:"Aplicativos comuns para Termux Desktop",code:`# Navegadores
...
pkg install timeshift             # Timeshift: backup e restauração do sistema`})]})}export{l as default};
