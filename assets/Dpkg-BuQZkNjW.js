import{j as e}from"./index-BGu3owFd.js";import{P as r,I as a}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(r,{title:"dpkg — Gerenciador de Pacotes de Baixo Nível",subtitle:"Guia completo do dpkg no Termux: instalar .deb, listar pacotes, verificar arquivos, reconfigurar e resolver problemas de pacotes.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"dpkg"})," "," — "," ","baixo nível."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"-i"})," "," — "," ","instala .deb."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"-l"})," "," — "," ","lista."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"-r"})," "," — "," ","remove."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"dpkg"})," é o gerenciador de pacotes de baixo nível do Debian/Termux. Enquanto o ",e.jsx("code",{children:"apt"})," resolve dependências automaticamente, o dpkg trabalha diretamente com arquivos ",e.jsx("code",{children:".deb"}),". É útil para instalar pacotes baixados manualmente, diagnosticar problemas e inspecionar o sistema de pacotes."]}),e.jsx("h2",{children:"1. Instalar e Remover Pacotes"}),e.jsx(o,{title:"Gerenciar pacotes .deb com dpkg",code:`# Instalar um pacote .deb
...
' | sort -rn | head -20
  ...
  pkg update`}),e.jsxs(a,{type:"info",title:"dpkg vs apt",children:["Use ",e.jsx("code",{children:"apt"})," para o dia a dia — ele chama o dpkg internamente e resolve dependências. Use ",e.jsx("code",{children:"dpkg"})," quando precisar instalar ",e.jsx("code",{children:".deb"}),"baixados manualmente, diagnosticar problemas de pacotes ou quando o apt falhar."]})]})}export{c as default};
