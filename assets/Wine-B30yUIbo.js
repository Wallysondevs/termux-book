import{j as e}from"./index-BGu3owFd.js";import{P as r,I as i}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function l(){return e.jsxs(r,{title:"Wine no Termux — Aplicativos Windows no Android",subtitle:"Por que Wine não roda nativo no Termux, e como tentar via proot-distro + Box86/Box64. Experimental, lento e limitado.",difficulty:"avancado",timeToRead:"25 min",children:[e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Wine"})," "," — "," ","runs Windows."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Winetricks"})," "," — "," ","dependências."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Bottles"})," "," — "," ","front-end."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"DXVK"})," "," — "," ","DirectX→Vulkan."]})]}),e.jsxs(i,{type:"warning",title:"Wine NÃO roda nativo no Termux",children:["Termux é Android (ARM/AArch64) sem root e sem suporte direto a binários x86 do Windows. ",e.jsxs("strong",{children:["Não existe pacote",e.jsx("code",{children:"wine"})," no repositório do Termux"]}),". A única forma razoável de rodar programas Windows é via uma distro Linux instalada com ",e.jsx("code",{children:"proot-distro"})," + ",e.jsx("strong",{children:"Box86/Box64"})," para traduzir x86→ARM. Tudo é ",e.jsx("strong",{children:"experimental, lento"})," e",e.jsx("strong",{children:" não roda jogos AAA, anti-cheat, DRM moderno"})," nem nada que dependa de drivers GPU dedicados. Para Office/Photoshop/jogos modernos, use o PC."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Wine"})," (Wine Is Not an Emulator) é uma camada de compatibilidade que traduz chamadas da API Windows para Linux. No Termux puro ele não existe — Termux roda em Android, e Wine precisa de uma userland Linux completa + um tradutor x86 (Box86/Box64) já que a maioria dos .exe é x86."]}),e.jsx("h2",{children:"1. Pré-requisitos"}),e.jsx(o,{title:"Atualizar Termux e instalar utilitários",code:`pkg update && pkg upgrade -y
...
# Dentro do proot:
export PULSE_SERVER=127.0.0.1`}),e.jsxs(i,{type:"info",title:"Alternativas",children:["Se a meta é só rodar 1 programinha Windows, considere: usar um PC remoto via ",e.jsx("strong",{children:"RDP"}),"/",e.jsx("strong",{children:"VNC"})," direto do app Android, ou rodar a mesma tarefa com um app Android nativo. Wine no Termux é mais um exercício técnico do que uma solução prática."]})]})}export{l as default};
