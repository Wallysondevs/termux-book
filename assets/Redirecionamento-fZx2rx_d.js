import{j as e}from"./index-BGu3owFd.js";import{P as r,I as a}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(r,{title:"Redirecionamento e Pipes",subtitle:"Guia completo de redirecionamento no Bash: stdin, stdout, stderr, pipes, tee, xargs, substituição de processos e combinações avançadas.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:">"})," "," — "," ","sobrescreve."]}),e.jsxs("li",{children:[e.jsx("strong",{children:">>"})," "," — "," ","anexa."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"<"})," "," — "," ","entrada."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"2>&1"})," "," — "," ","funde."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"redirecionamento"})," permite controlar para onde vai a saída de um comando e de onde vem sua entrada. Junto com ",e.jsx("strong",{children:"pipes"})," (",e.jsx("code",{children:"|"}),"), é uma das funcionalidades mais poderosas do terminal Linux, permitindo encadear comandos para criar fluxos de processamento complexos."]}),e.jsx("h2",{children:"1. Descritores de Arquivo"}),e.jsx(o,{title:"Entender stdin, stdout e stderr",code:`# Todo processo no Linux tem 3 fluxos padrão:
