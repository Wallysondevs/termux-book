import{j as e}from"./index-CbmJLKV7.js";import{P as i}from"./PageContainer-C07HsLrK.js";import{C as a}from"./CodeBlock-hEuZNnwQ.js";import{I as o}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function l(){return e.jsxs(i,{title:"Multimídia e Codecs no Termux",subtitle:"Instalação de codecs, reprodução de áudio e vídeo, edição de imagens, gravação de tela, conversão de formatos e streaming no Termux.",difficulty:"iniciante",timeToRead:"30 min",children:[e.jsx("p",{children:"Por questões de licenciamento, o Termux não inclui codecs proprietários por padrão. Isso significa que arquivos MP3, MP4, H.264, H.265, AAC e outros formatos populares podem não funcionar sem instalar pacotes extras. Este guia cobre tudo o que você precisa para ter uma experiência multimídia completa."}),e.jsx("h2",{children:"1. Instalar Codecs e Formatos"}),e.jsx(a,{title:"Instalar todos os codecs necessários",code:`# Instalar o pacote de codecs restritos do Termux (ESSENCIAL)
  ...
  gst-inspect-1.0 | grep -i "h264|h265|mp3|aac"`}),e.jsxs(o,{type:"info",title:"Por que codecs não vêm pré-instalados?",children:["Codecs como MP3 e H.264 são protegidos por patentes em alguns países. O Termux, mantido pela Termux Project (empresa sediada no Reino Unido), não pode distribuí-los por padrão. O pacote ",e.jsx("code",{children:"termux-restricted-extras"})," resolve isso para o usuário."]}),e.jsx("h2",{children:"2. Reprodutores de Vídeo"}),e.jsx(a,{title:"Instalar reprodutores de vídeo",code:`# VLC — O reprodutor mais completo e versátil
  pkg install -y vlc
  ...
  mpv "https://www.youtube.com/watch?v=ID_DO_VIDEO"`}),e.jsx("h2",{children:"3. Reprodutores de Áudio"}),e.jsx(a,{title:"Instalar reprodutores de áudio",code:`# Rhythmbox — Reprodutor padrão do Termux (já vem instalado)
  ...
  gnome-screenshot -d 5             # Captura com delay de 5 segundos`}),e.jsx("h2",{children:"6. Gravação de Tela"}),e.jsx(a,{title:"Gravar a tela no Termux",code:`# OBS Studio — O melhor para gravação e streaming
  ...
  pkg install -y termux-restricted-extras gstreamer1.0-plugins-bad     gstreamer1.0-plugins-ugly gstreamer1.0-libav
  ...
  arecord -l   # Lista dispositivos de captura de áudio`}),e.jsxs(o,{type:"info",title:"PipeWire vs PulseAudio",children:["O Termux 0.118+ usa o ",e.jsx("strong",{children:"PipeWire"})," como servidor de áudio padrão, substituindo o PulseAudio. O PipeWire é compatível com PulseAudio, ALSA e JACK, oferecendo menor latência e melhor suporte a Bluetooth. Comandos do PulseAudio (como ",e.jsx("code",{children:"pavucontrol"}),") continuam funcionando normalmente."]})]})}export{l as default};
