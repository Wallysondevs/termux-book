...
grep "Failed password" /var/log/auth.log | \\
    ...
    # -n = numérico
    head -10   # Top 10 IPs mais frequentes`}),a.jsx("h2",{children:"Lendo Logs Importantes do Termux"}),a.jsx(e,{title:"Os logs mais úteis do dia a dia",code:`# Log geral do sistema (tudo que acontece no Termux)
tail -f /var/log/syslog
