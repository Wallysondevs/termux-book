import{j as s}from"./index-BGu3owFd.js";import{P as e,I as o}from"./InfoBox-cbYNoYJG.js";import{C as a}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return s.jsxs(e,{title:"Zsh — Shell Avançado",subtitle:"Instalação do Zsh e Oh My Zsh no Termux: plugins, temas, autocompletar, aliases, histórico e personalização completa do terminal.",difficulty:"iniciante",timeToRead:"25 min",children:[s.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),s.jsx("h2",{children:"Glossário rápido"}),s.jsxs("ul",{children:[s.jsxs("li",{children:[s.jsx("strong",{children:"Zsh"})," "," — "," ","shell alt."]}),s.jsxs("li",{children:[s.jsx("strong",{children:"Oh My Zsh"})," "," — "," ","framework."]}),s.jsxs("li",{children:[s.jsx("strong",{children:"Powerlevel10k"})," "," — "," ","tema."]}),s.jsxs("li",{children:[s.jsx("strong",{children:"chsh"})," "," — "," ","muda padrão."]})]}),s.jsxs("p",{children:["O ",s.jsx("strong",{children:"Zsh"})," (Z Shell) é um shell avançado compatível com Bash, mas com recursos extras como autocompletar inteligente, correção de erros, globbing avançado e temas visuais. Com o ",s.jsx("strong",{children:"Oh My Zsh"}),", se torna o shell mais produtivo e bonito do Linux."]}),s.jsx("h2",{children:"1. Instalação e Configuração"}),s.jsx(a,{title:"Instalar o Zsh e torná-lo padrão",code:`# Instalar o Zsh
  pkg update
  pkg install -y zsh
  ...
  # No terminal do Termux: Preferências → Perfil → Fonte`}),s.jsx("h2",{children:"3. Plugins Essenciais"}),s.jsx(a,{title:"Instalar e configurar plugins do Oh My Zsh",code:`# Os plugins são ativados no ~/.zshrc:
