import{j as e}from"./index-BGu3owFd.js";import{P as a,I as o}from"./InfoBox-cbYNoYJG.js";import{C as s}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function p(){return e.jsxs(a,{title:"Node.js no Termux",subtitle:"Instalação via NVM, gerenciamento de versões, NPM, Yarn, PNPM, criação de projetos, PM2 para produção e deploy de aplicações Node.js.",difficulty:"intermediario",timeToRead:"35 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Node.js"})," "," — "," ","runtime JS."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"npm"})," "," — "," ","pacotes."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"nvm"})," "," — "," ","multi-versões."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"pnpm"})," "," — "," ","alternativa rápida."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Node.js"})," é um runtime JavaScript construído sobre o motor V8 do Chrome, permitindo executar JavaScript fora do navegador. É a base de frameworks como Express, Next.js, Nest.js, e ferramentas como Webpack, Vite e ESLint."]}),e.jsx("h2",{children:"Métodos de Instalação"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"NVM (recomendado)"})," — Gerenciador de versões. Permite ter múltiplas versões instaladas e alternar entre elas facilmente."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"NodeSource"})," — Repositório oficial com versões atualizadas. Instala uma única versão global."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"apt"})," — Versão dos repositórios do Termux. Geralmente desatualizada."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"fnm"})," — Alternativa ao NVM, escrita em Rust (mais rápida)."]})]}),e.jsx("h2",{children:"1. Instalar via NVM (Recomendado)"}),e.jsx(s,{title:"Instalar o NVM e o Node.js",code:`# Instalar o NVM (Node Version Manager)
  ...
  nvm exec 18 node -v   # Executa com Node 18 sem mudar a sessão`}),e.jsxs(o,{type:"info",title:"NVM e novos terminais",children:["O NVM configura a versão do Node.js ",e.jsx("strong",{children:"por sessão de terminal"}),". Se você abrir um novo terminal, ele usará a versão definida como ",e.jsx("code",{children:"default"}),". Para projetos que precisam de uma versão específica, crie um arquivo",e.jsx("code",{children:".nvmrc"})," na raiz do projeto com o número da versão (ex: ",e.jsx("code",{children:"20"}),")."]}),e.jsx("h2",{children:"2. Instalar via NodeSource (Alternativa)"}),e.jsx(s,{title:"Instalar Node.js via repositório NodeSource",code:`# Instalar o Node.js 20 via NodeSource
  ...
  # Desvantagem: não permite múltiplas versões facilmente`}),e.jsx("h2",{children:"3. Gerenciadores de Pacotes: NPM, Yarn, PNPM"}),e.jsx(s,{title:"Comparação e instalação dos gerenciadores",code:`# === NPM (já vem com o Node.js) ===
  ...
  # - Workspaces nativos para monorepos`}),e.jsx("h2",{children:"4. Criar e Executar Projetos"}),e.jsx(s,{title:"Primeiros passos com Node.js",code:`# Criar um projeto Node.js
  ...
  # Depois use: import express from 'express';`}),e.jsx("h2",{children:"5. TypeScript com Node.js"}),e.jsx(s,{title:"Configurar TypeScript",code:`# Instalar TypeScript e tipos do Node
  ...
  npm install -D tsx
  npx tsx src/index.ts`}),e.jsx("h2",{children:"6. PM2 — Gerenciador de Processos para Produção"}),e.jsx(s,{title:"Usar PM2 para deploy em produção",code:`# Instalar o PM2 globalmente
  npm install -g pm2
  ...
  pm2 start ecosystem.config.js --env development  # Desenvolvimento`}),e.jsx("h2",{children:"7. Ferramentas de Desenvolvimento"}),e.jsx(s,{title:"Ferramentas essenciais para desenvolvimento Node.js",code:`# Nodemon — reinicia automaticamente ao salvar
  ...
  npm install mongoose          # ODM para MongoDB`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(s,{title:"Problemas comuns com Node.js no Termux",code:`# Erro: "node: command not found" após instalar via NVM
  ...
  # Limpar cache do NPM
  npm cache clean --force`}),e.jsxs(o,{type:"info",title:"Node.js LTS vs Current",children:["O Node.js tem dois tipos de release: ",e.jsx("strong",{children:"LTS"})," (Long Term Support, versões pares: 18, 20, 22) e ",e.jsx("strong",{children:"Current"})," (versões ímpares: 19, 21, 23). Para produção, sempre use LTS. Current é para testar funcionalidades novas."]})]})}export{p as default};
