import{j as e}from"./index-BGu3owFd.js";import{P as a,I as s}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(a,{title:"Hierarquia do Sistema de Arquivos (FHS)",subtitle:"O mapa do Linux — entenda o que existe em cada diretório, de / até /var/log, e por que tudo está onde está.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"ext4"})," "," — "," ","padrão."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Btrfs"})," "," — "," ","CoW."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"XFS"})," "," — "," ","servidores."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"ZFS"})," "," — "," ","features avançadas."]})]}),e.jsxs("p",{children:["No Linux, tudo começa em ",e.jsx("strong",{children:"/"}),' (barra) — a raiz. Diferente do Windows que tem letras de drive (C:, D:, E:), no Linux existe apenas uma árvore de diretórios a partir da raiz. Todos os discos, pen drives e partições são "montados" em algum ponto dessa árvore.']}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"FHS"})," (Filesystem Hierarchy Standard) é a especificação que define onde cada tipo de arquivo deve ficar. Todas as distribuições Linux respeitam esse padrão, o que significa que o conhecimento sobre a estrutura de arquivos é portátil entre Termux, Fedora, Arch e outros."]}),e.jsx("h2",{children:"Mapa Completo dos Diretórios"}),e.jsx(o,{title:"A árvore de diretórios do Linux",code:`/                    ← Raiz (Root) — tudo começa aqui
...
/etc/timezone                # Fuso horário atual`}),e.jsx("h3",{children:"/var — Dados Variáveis"}),e.jsx(o,{title:"O que fica em /var",code:`/var/log/syslog          # Log geral do sistema (Termux)
...
blkid /dev/sdb1`}),e.jsxs(s,{type:"warning",title:"Use UUID no /etc/fstab, não /dev/sdb",children:["A letra de um disco (sda, sdb) pode mudar entre reboots se você adicionar novos discos. Use sempre o UUID, que é permanente. Encontre com ",e.jsx("code",{children:"blkid"}),"."]})]})}export{c as default};
