import{j as o}from"./index-BGu3owFd.js";import{P as a,I as r}from"./InfoBox-cbYNoYJG.js";import{C as e}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return o.jsxs(a,{title:"Manipulação de Arquivos",subtitle:"cp, mv, rm, mkdir, touch, ln — criando, copiando, movendo e removendo arquivos e diretórios com segurança e eficiência.",difficulty:"iniciante",timeToRead:"20 min",children:[o.jsx(r,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"cat/less"})," "," — "," ","exibe."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"head/tail"})," "," — "," ","linhas."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"grep"})," "," — "," ","busca."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"sed/awk"})," "," — "," ","processa."]})]}),o.jsx("p",{children:"Manipular arquivos é uma das atividades mais básicas e importantes no terminal Linux. Esses comandos parecem simples mas têm opções poderosas que economizam muito tempo no dia a dia. Aprenda-os bem — você os usará constantemente."}),o.jsx("h2",{children:"mkdir — Criar Diretórios"}),o.jsx(e,{title:"Criando diretórios",code:`# Criar um diretório simples
mkdir MeuDiretorio
