import{j as r}from"./index-BGu3owFd.js";import{P as a,I as e}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function m(){return r.jsxs(a,{title:"Permissões de Arquivos",subtitle:"chmod, chown, umask — entendendo e gerenciando o sistema de permissões do Linux de forma completa e segura.",difficulty:"intermediario",timeToRead:"20 min",children:[r.jsx(e,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),r.jsx("h2",{children:"Glossário rápido"}),r.jsxs("ul",{children:[r.jsxs("li",{children:[r.jsx("strong",{children:"chmod"})," "," — "," ","muda perms."]}),r.jsxs("li",{children:[r.jsx("strong",{children:"chown"})," "," — "," ","muda dono."]}),r.jsxs("li",{children:[r.jsx("strong",{children:"rwx"})," "," — "," ","read/write/execute."]}),r.jsxs("li",{children:[r.jsx("strong",{children:"755"})," "," — "," ","rwxr-xr-x."]})]}),r.jsx("p",{children:"O sistema de permissões do Linux é um dos seus recursos mais poderosos e importantes para segurança. Ele controla quem pode ler, escrever e executar cada arquivo ou diretório. Entender permissões é essencial para administrar qualquer sistema Linux."}),r.jsx("h2",{children:"Lendo Permissões"}),r.jsx(o,{title:"Interpretando a saída do ls -l",code:`ls -l /home/joao/
...
# ---  = sem nenhuma permissão               = 0+0+0 = 0`}),r.jsx("h2",{children:"chmod — Mudar Permissões"}),r.jsx("h3",{children:"Modo Numérico (Octal)"}),r.jsx(o,{title:"chmod com números octais",code:`# Formato: chmod [user][group][others] arquivo
...
# Sem -R, apenas o diretório raiz receberia a permissão.`}),r.jsx("h3",{children:"Modo Simbólico (mais legível para iniciantes)"}),r.jsx(o,{title:"chmod com símbolos — mais fácil de entender",code:`# Formato: chmod [quem][operação][permissão] arquivo
...
# -type d = apenas diretórios (d = directory)`}),r.jsxs(e,{type:"warning",title:"Permissões em diretórios são diferentes!",children:["Para ",r.jsx("strong",{children:"diretórios"}),", as letras têm significados diferentes dos arquivos:",r.jsxs("ul",{className:"mt-1 mb-0",children:[r.jsxs("li",{children:[r.jsx("strong",{children:"r"})," = listar o conteúdo do diretório (",r.jsx("code",{children:"ls"}),")"]}),r.jsxs("li",{children:[r.jsx("strong",{children:"w"})," = criar, renomear ou deletar arquivos DENTRO do diretório"]}),r.jsxs("li",{children:[r.jsx("strong",{children:"x"})," = entrar no diretório (",r.jsx("code",{children:"cd"}),") e acessar seus conteúdos"]})]}),"Um diretório com ",r.jsx("code",{children:"r--"})," permite ver a lista mas não entrar. Com ",r.jsx("code",{children:"--x"}),"você pode entrar mas não ver a lista. Na prática sempre use ",r.jsx("code",{children:"r-x"})," (5) ou ",r.jsx("code",{children:"rwx"})," (7) para diretórios."]}),r.jsx("h2",{children:"chown — Mudar Dono e Grupo"}),r.jsx(o,{title:"Mudando a propriedade de arquivos",code:`# Mudar o DONO de um arquivo
...
#    O usuário precisa fazer logout e login novamente.`}),r.jsx("h2",{children:"Permissões Especiais"}),r.jsx(o,{title:"SUID, SGID e Sticky Bit explicados",code:`# === SUID (Set User ID) ===
...
# %a = exibir permissões em octal (ex: 4755 = SUID + 755)`}),r.jsx("h2",{children:"umask — Permissões Padrão para Novos Arquivos"}),r.jsx(o,{title:"Como o umask define permissões padrão",code:`# Ver o umask atual do usuário
umask
...
# ~/.bashrc é executado a cada abertura de terminal`}),r.jsx("h2",{children:"ACL — Controle de Acesso Avançado"}),r.jsx("p",{children:"O sistema padrão do Linux só permite definir permissões para três entidades: dono, grupo e outros. A ACL (Access Control List) permite dar permissões específicas para qualquer usuário ou grupo, indo além dessa limitação."}),r.jsx(o,{title:"ACL: permissões granulares por usuário",code:`# Instalar ferramentas de ACL
pkg install acl
