import{j as a}from"./index-CbmJLKV7.js";import{P as o}from"./PageContainer-C07HsLrK.js";import{C as e}from"./CodeBlock-hEuZNnwQ.js";import{I as r}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function c(){return a.jsxs(o,{title:"Java no Termux",subtitle:"Instalação, configuração e gerenciamento do Java Development Kit (JDK) e Java Runtime Environment (JRE) no Termux. Do OpenJDK ao Oracle JDK.",difficulty:"intermediario",timeToRead:"30 min",children:[a.jsxs("p",{children:["O ",a.jsx("strong",{children:"Java"})," é uma das linguagens de programação mais utilizadas no mundo, especialmente em aplicações empresariais, desenvolvimento Android, servidores web e sistemas embarcados. No Termux, o Java está disponível principalmente através do",a.jsx("strong",{children:" OpenJDK"}),", a implementação open source mantida pela comunidade e pela Oracle."]}),a.jsx("h2",{children:"JDK vs JRE — Qual Instalar?"}),a.jsx("p",{children:"Antes de instalar, você precisa entender a diferença entre JDK e JRE:"}),a.jsxs("ul",{children:[a.jsxs("li",{children:[a.jsx("strong",{children:"JRE (Java Runtime Environment)"})," — apenas executa aplicações Java. Contém a JVM (Java Virtual Machine) e bibliotecas padrão. Use se você só precisa ",a.jsx("em",{children:"rodar"})," programas Java."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"JDK (Java Development Kit)"})," — inclui o JRE + ferramentas de desenvolvimento (compilador ",a.jsx("code",{children:"javac"}),", depurador, etc.). Use se você vai ",a.jsx("em",{children:"desenvolver"})," em Java."]})]}),a.jsx(r,{type:"info",title:"Recomendação",children:"Se você está em dúvida, instale o JDK. Ele inclui o JRE, então você consegue tanto desenvolver quanto executar aplicações Java. Se precisar apenas rodar um arquivo .jar, o JRE é suficiente."}),a.jsx("h2",{children:"1. Verificar se o Java Já Está Instalado"}),a.jsx(e,{title:"Verificar instalação do Java",code:`# Verificar a versão do Java instalado
  java -version
  ...
  java -version
  javac -version`}),a.jsx(r,{type:"info",title:"Versões LTS do Java",children:"O Java segue um ciclo de lançamentos a cada 6 meses, mas apenas algumas versões recebem suporte de longo prazo (LTS): Java 8, 11, 17, 21. Para produção, sempre prefira versões LTS. O Termux 0.118 usa o Java 21 como padrão."}),a.jsx("h2",{children:"3. Instalar o Oracle JDK"}),a.jsx("p",{children:"Em alguns casos, você pode precisar do JDK oficial da Oracle (por exemplo, para licenciamento específico ou recursos exclusivos). A instalação requer adicionar um repositório de terceiros."}),a.jsx(e,{title:"Instalação do Oracle JDK via PPA",code:`# Adicionar o repositório do Linux Uprising (mantém o Oracle JDK atualizado)
  ...
  pkg -f install`}),a.jsx("h2",{children:"4. Gerenciar Múltiplas Versões do Java"}),a.jsxs("p",{children:["É comum ter mais de uma versão do Java instalada. O Termux usa o sistema",a.jsx("code",{children:"update-alternatives"})," para gerenciar qual versão é a padrão."]}),a.jsx(e,{title:"Alternar entre versões do Java",code:`# Ver todas as versões do Java instaladas e escolher a padrão
  ...
  sdk install gradle
  sdk install kotlin
  sdk install scala`}),a.jsx("h2",{children:"9. Configurar IDEs para Java"}),a.jsx(e,{title:"Instalar IDEs Java no Termux",code:`# === IntelliJ IDEA (IDE mais popular para Java) ===
  ...
  # O Tomcat faz deploy automático do .war`}),a.jsx("h2",{children:"Troubleshooting"}),a.jsx(e,{title:"Problemas comuns com Java no Termux",code:`# Erro: "java: command not found"
  ...
  dpkg -l | grep -E '(jdk|jre|java)'`}),a.jsxs(r,{type:"info",title:"Java no Docker",children:["Para projetos em produção, considere usar imagens Docker oficiais do Java como ",a.jsx("code",{children:"eclipse-temurin:21-jdk"})," ou ",a.jsx("code",{children:"amazoncorretto:21"}),". Isso garante consistência entre desenvolvimento e produção."]})]})}export{c as default};
