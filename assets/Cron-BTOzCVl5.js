import{j as e}from"./index-BGu3owFd.js";import{P as r,I as a}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return e.jsxs(r,{title:"Cron — Agendamento de Tarefas",subtitle:"Guia completo do cron e systemd timers no Termux: agendar tarefas automáticas, sintaxe do crontab, exemplos práticos e monitoramento.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"cron"})," "," — "," ","agendador."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"crontab -e"})," "," — "," ","edita."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"anacron"})," "," — "," ","jobs perdidos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"systemd timer"})," "," — "," ","alternativa."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"cron"})," é o agendador de tarefas padrão do Linux. Permite executar comandos e scripts automaticamente em horários e intervalos definidos — backups diários, limpeza de logs, sincronização de dados, relatórios semanais e qualquer tarefa que precise rodar periodicamente."]}),e.jsx("h2",{children:"1. Sintaxe do Crontab"}),e.jsx(o,{title:"Entender a sintaxe do crontab",code:`# Formato: minuto hora dia-do-mês mês dia-da-semana comando
  #          ┌───── minuto (0-59)
  #          │ ┌───── hora (0-23)
  #          │ │ ┌───── dia do mês (1-31)
  #          │ │ │ ┌───── mês (1-12)
  ...
  * * * * * flock -n /tmp/meu-script.lock /usr/local/bin/meu-script.sh
  ...
  # Ou definir MAILTO="" no crontab`})]})}export{d as default};
