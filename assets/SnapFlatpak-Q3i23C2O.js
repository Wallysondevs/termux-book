...
termux-reload-settings`}),e.jsxs(r,{type:"success",title:"Resumo dos pacotes CLI",children:["Cada app companion tem um pacote correspondente que precisa ser instalado:",e.jsx("code",{children:"termux-api"}),", ",e.jsx("code",{children:"termux-x11-nightly"})," etc. O app sozinho não basta — e o pacote sozinho também não. Os dois trabalham em conjunto via intents do Android."]})]})}export{l as default};
