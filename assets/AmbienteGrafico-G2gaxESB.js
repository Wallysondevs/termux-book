import{j as e}from"./index-CbmJLKV7.js";import{P as r}from"./PageContainer-C07HsLrK.js";import{C as s}from"./CodeBlock-hEuZNnwQ.js";import{I as a}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function c(){return e.jsxs(r,{title:"Layout do Teclado & Gestos no Termux",subtitle:"Configurando, personalizando e dominando o GNOME — o ambiente gráfico padrão do Termux.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsxs("p",{children:["O Termux usa o ",e.jsx("strong",{children:"GNOME"})," como ambiente gráfico padrão desde o Termux 17.10. O GNOME (GNU Network Object Model Environment) é um dos ambientes de desktop mais modernos e polidos do Linux, com design limpo e foco em simplicidade. O Termux customiza levemente o GNOME vanilla com sua própria estética laranja/roxa."]}),e.jsx("h2",{children:"GNOME: Conceitos Básicos"}),e.jsx("h3",{children:"Activities Overview"}),e.jsxs("p",{children:["Pressione a tecla ",e.jsx("strong",{children:"Super"}),' (tecla Windows) ou clique em "Activities" no canto superior esquerdo para abrir o Overview. Aqui você pode:']}),e.jsxs("ul",{children:[e.jsx("li",{children:"Ver todas as janelas abertas"}),e.jsx("li",{children:"Pesquisar aplicativos digitando diretamente"}),e.jsx("li",{children:"Navegar entre workspaces (áreas de trabalho)"}),e.jsx("li",{children:"Pesquisar arquivos, configurações e até fazer cálculos"})]}),e.jsx("h3",{children:"Atalhos de Teclado Essenciais"}),e.jsx(s,{title:"Atalhos do GNOME mais usados",code:`Super                  # Abrir Activities Overview
...
# pois o xrandr tem suporte limitado no Wayland`}),e.jsxs(a,{type:"warning",title:"X11 vs Wayland",children:["O Termux 0.118+ usa ",e.jsx("strong",{children:"Wayland"}),' como sessão padrão, o que melhora segurança e suporte a displays de alta resolução. Alguns aplicativos mais antigos podem não funcionar perfeitamente no Wayland. Se precisar, você pode voltar ao X11 na tela de login: clique no ícone de engrenagem antes de fazer login e selecione "Termux em Xorg".']}),e.jsx("h2",{children:"Desempenho e Recursos"}),e.jsx(s,{title:"Verificar uso de recursos do sistema gráfico",code:`# Ver uso de memória geral
free -h
