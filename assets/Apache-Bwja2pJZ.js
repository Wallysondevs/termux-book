...
httpd
EOF
chmod +x ~/.termux/boot/start-apache`}),e.jsxs(a,{type:"info",title:"Nginx ou Apache no Termux?",children:["Os dois rodam bem. O ",e.jsx("strong",{children:"Nginx"})," consome menos memória e é mais leve pra estáticos e proxy. O ",e.jsx("strong",{children:"Apache"})," brilha quando você precisa de ",e.jsx("code",{children:".htaccess"})," e ",e.jsx("code",{children:"mod_rewrite"}),"complexo (ex.: portar um projeto WordPress/Laravel local sem mexer em vhost)."]})]})}export{n as default};
