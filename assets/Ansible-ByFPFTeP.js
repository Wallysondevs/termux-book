import{j as e}from"./index-BGu3owFd.js";import{P as i,I as s}from"./InfoBox-cbYNoYJG.js";import{C as a}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return e.jsxs(i,{title:"Ansible — Automação de Infraestrutura",subtitle:"Guia completo do Ansible no Termux: instalação, inventários, playbooks, roles, modules, vaults e automação de servidores em escala.",difficulty:"avancado",timeToRead:"40 min",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Ansible"})," "," — "," ","automação SSH."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Playbook"})," "," — "," ","YAML de tasks."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Inventory"})," "," — "," ","hosts."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Idempotência"})," "," — "," ","re-rodar é ok."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Ansible"})," é uma ferramenta de automação de infraestrutura que permite configurar, gerenciar e fazer deploy em centenas de servidores simultaneamente usando apenas SSH. Diferente de ferramentas como Puppet ou Chef, o Ansible é ",e.jsx("em",{children:"agentless"})," — não precisa instalar nada nos servidores gerenciados, apenas SSH e Python."]}),e.jsx("h2",{children:"Por Que Ansible?"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Agentless"})," — Não precisa instalar software nos servidores gerenciados. Usa SSH."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Idempotente"})," — Executar a mesma tarefa várias vezes produz o mesmo resultado. Se o servidor já está configurado, nada muda."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"YAML"})," — Configuração em YAML legível por humanos, não em linguagem de programação."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Push-based"})," — Você executa os comandos do seu computador e eles são aplicados nos servidores remotos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Extensível"})," — Milhares de módulos para cloud (AWS, Azure, GCP), containers (Docker, K8s), redes e mais."]})]}),e.jsx("h2",{children:"1. Instalação do Ansible"}),e.jsx(a,{title:"Instalar o Ansible no Termux",code:`# Método 1: Via apt (versão estável do Termux)
  ...
  ansible all -i inventory.ini -m shell -a "pkg update" --become -f 2`}),e.jsx("h2",{children:"4. Playbooks — Automação Estruturada"}),e.jsx(a,{title:"Criar e executar playbooks",code:`# Playbook básico: instalar e configurar o Nginx
