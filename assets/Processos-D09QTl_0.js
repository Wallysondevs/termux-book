import{j as o}from"./index-BGu3owFd.js";import{P as r,I as s}from"./InfoBox-cbYNoYJG.js";import{C as e}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function p(){return o.jsxs(r,{title:"Gerenciamento de Processos",subtitle:"Guia completo de processos no Termux: ps, top, htop, kill, nice, jobs, sinais, prioridade e monitoramento avançado.",difficulty:"iniciante",timeToRead:"25 min",children:[o.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"ps"})," "," — "," ","lista."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"top/htop"})," "," — "," ","monitor."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"kill"})," "," — "," ","encerra."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"nice"})," "," — "," ","prioridade."]})]}),o.jsxs("p",{children:["Todo programa em execução no Linux é um ",o.jsx("strong",{children:"processo"}),". Cada processo tem um ",o.jsx("strong",{children:"PID"})," (Process ID) único, um dono, prioridade e consome recursos (CPU, memória, I/O). Saber gerenciar processos é essencial para manter o sistema responsivo e resolver problemas de performance."]}),o.jsx("h2",{children:"1. Ver Processos (ps)"}),o.jsx(e,{title:"Listar processos em execução",code:`# Ver seus processos
  ...
  nmon                     # Monitor IBM (pkg install nmon)`}),o.jsx("h2",{children:"3. Sinais e Kill"}),o.jsx(e,{title:"Enviar sinais a processos",code:`# Listar todos os sinais
  kill -l
