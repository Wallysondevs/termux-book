import{j as e}from"./index-BGu3owFd.js";import{P as a,I as r}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function n(){return e.jsxs(a,{title:"Storage do Android e o Termux",subtitle:"Entenda /data, /sdcard, scoped storage, OBB e como o Termux acessa o armazenamento compartilhado via termux-setup-storage.",difficulty:"iniciante",timeToRead:"15 min",children:[e.jsx(r,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"fdisk"})," "," — "," ","MBR."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"gdisk"})," "," — "," ","GPT."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"parted"})," "," — "," ","script-friendly."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"mkfs"})," "," — "," ","formata."]})]}),e.jsxs(r,{type:"danger",title:"NÃO use fdisk/parted/gparted no Android — risco de brick",children:["O esquema de partições do Android é controlado pelo bootloader e por partições críticas como ",e.jsx("code",{children:"boot"}),", ",e.jsx("code",{children:"system"}),","," ",e.jsx("code",{children:"vendor"}),", ",e.jsx("code",{children:"vbmeta"}),", ",e.jsx("code",{children:"userdata"}),". Mexer com ",e.jsx("code",{children:"fdisk"}),", ",e.jsx("code",{children:"parted"})," ou ",e.jsx("code",{children:"gparted"})," no bloco do celular pode ",e.jsx("strong",{children:"brickar o aparelho permanentemente"}),". Sem root o Termux nem te deixa fazer isso (os blocos são read-only) — e mesmo com root, ",e.jsx("strong",{children:"não faça"}),". Este capítulo é sobre entender o storage existente, não sobre alterá-lo."]}),e.jsxs("p",{children:["Em vez de gerenciar partições, no Android você lida com"," ",e.jsx("strong",{children:"áreas lógicas de storage"}),' definidas pelo sistema: armazenamento interno do app, armazenamento compartilhado (a "memória" do usuário) e cartão SD opcional. O Termux precisa de uma permissão explícita para ler/escrever fora da própria área.']}),e.jsx("h2",{children:'1. As "partições" lógicas que você verá'}),e.jsx(o,{title:"Áreas de storage do Android",code:`# === ÁREA PRIVADA DO TERMUX (sandbox do app) ===
...
# → CORRETO. Não tente. Você não particiona Android pelo Termux.`}),e.jsxs(r,{type:"info",title:"Backup é o substituto do 'particionar'",children:["Como você não cria partições, a estratégia de backup no Termux é diferente: copie ",e.jsx("code",{children:"$HOME"})," e (se quiser) ",e.jsx("code",{children:"$PREFIX"})," ","com ",e.jsx("code",{children:"tar"}),"/",e.jsx("code",{children:"rsync"})," para ",e.jsx("code",{children:"~/storage/shared"})," ","e de lá envie para nuvem/PC. Veja o capítulo de Backup para o passo a passo."]})]})}export{n as default};
