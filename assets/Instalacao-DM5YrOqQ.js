import{j as e}from"./index-BGu3owFd.js";import{P as s,I as a}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function l(){return e.jsxs(s,{title:"Guia de Instalação do Termux",subtitle:"Instalação completa do Termux Desktop e Server — do pen drive bootável até o primeiro login, passo a passo.",difficulty:"iniciante",timeToRead:"30 min",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"ISO"})," "," — "," ","imagem."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"USB boot"})," "," — "," ","dd ou rufus."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Particionamento"})," "," — "," ","fdisk/parted."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Bootloader"})," "," — "," ","GRUB."]})]}),e.jsx("p",{children:"Instalar o Termux é um dos processos mais simples no mundo Linux. Diferente do Arch Linux (que exige linha de comando pura), o Termux tem um instalador gráfico intuitivo com botões grandes e linguagem clara. Este guia cobre Termux 0.118 (Noble Numbat) tanto para Desktop quanto para Server."}),e.jsx("h2",{children:"Pré-Requisitos"}),e.jsxs("ul",{children:[e.jsxs("li",{children:["Pen drive de pelo menos ",e.jsx("strong",{children:"4GB"})," (será formatado)"]}),e.jsx("li",{children:"Conexão com internet (recomendado durante a instalação)"}),e.jsx("li",{children:"PC com boot UEFI ou BIOS legada"}),e.jsx("li",{children:"Mínimo: 25GB de disco, 4GB RAM. Recomendado: 50GB+ disco, 8GB RAM"}),e.jsx("li",{children:"Backup de todos os dados importantes — a instalação pode apagar dados"})]}),e.jsx("h2",{children:"1. Baixar a ISO"}),e.jsxs("p",{children:["Acesse ",e.jsx("code",{children:"termux.dev/download"})," e baixe a versão desejada:"]}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Termux"}),": Para uso pessoal com interface gráfica. Arquivo ~5GB."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Termux"}),": Para servidores, sem interface gráfica. Arquivo ~2GB."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Termux"}),": Versão de suporte longo (5 anos). Recomendado para todos."]})]}),e.jsxs(a,{type:"success",title:"Verifique o checksum SHA256",children:["Após baixar, verifique a integridade do arquivo para garantir que não foi corrompido:",e.jsx("code",{children:"sha256sum termux-24.04-desktop-amd64.iso"})," e compare com o hash no site oficial."]}),e.jsx("h2",{children:"2. Criar o Pen Drive Bootável"}),e.jsx("h3",{children:"No Linux"}),e.jsx(o,{title:"Gravar ISO no pen drive (Linux)",code:`# Descobrir o dispositivo do pen drive
lsblk
...
pkg install pv
pv termux-24.04-desktop-amd64.iso | sudo dd bs=4M of=/dev/sdb oflag=sync`}),e.jsx("h3",{children:"No Windows ou macOS"}),e.jsxs("p",{children:["Use o ",e.jsx("strong",{children:"balenaEtcher"})," (",e.jsx("code",{children:"etcher.balena.io"}),") — selecione a ISO, selecione o pen drive, clique em Flash. É simples assim. Outra opção no Windows é o ",e.jsx("strong",{children:"Rufus"})," (",e.jsx("code",{children:"rufus.ie"}),")."]}),e.jsx("h2",{children:"3. Dar Boot pelo Pen Drive"}),e.jsx("p",{children:"Insira o pen drive, reinicie o computador e entre no menu de boot:"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"ASUS"}),": F8 ou ESC"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Acer"}),": F12"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Dell"}),": F12"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"HP"}),": F9 ou ESC"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Lenovo"}),": F12 ou Fn+F12"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"MSI"}),": F11"]})]}),e.jsxs("p",{children:["Se o pen drive não aparecer, desabilite o ",e.jsx("strong",{children:"Secure Boot"})," na BIOS/UEFI (normalmente em Security → Secure Boot → Disabled)."]}),e.jsx("h2",{children:"4. Instalação do Termux Desktop"}),e.jsx("h3",{children:"Tela de Boas-Vindas"}),e.jsxs("p",{children:["Após o boot, você pode escolher ",e.jsx("strong",{children:'"Try Termux"'})," (testar sem instalar) ou",e.jsx("strong",{children:'"Install Termux"'}),". Escolha instalar. Selecione o idioma ",e.jsx("strong",{children:"Português (Brasil)"}),' e clique em "Instalar Termux".']}),e.jsx("h3",{children:"Configurações Iniciais"}),e.jsx(o,{title:"Telas do instalador Termux 0.118",code:`Tela 1: Tipo de teclado
...
● Solicitar senha para entrar      # Recomendado`}),e.jsxs("p",{children:["A instalação começa e leva entre 10-20 minutos dependendo da velocidade do disco e da internet. Ao final, clique em ",e.jsx("strong",{children:'"Reiniciar"'})," e remova o pen drive quando solicitado."]}),e.jsx("h2",{children:"5. Instalação do Termux Server"}),e.jsxs("p",{children:["O Termux usa o instalador ",e.jsx("strong",{children:"Subiquity"}),", uma interface de texto (não gráfica) que funciona em qualquer servidor."]}),e.jsx(o,{title:"Etapas do instalador Termux",code:`# Tela 1: Idioma
...
# Instalação começa automaticamente. Ao final: Reboot.`}),e.jsxs(a,{type:"warning",title:"OpenSSH no Server é essencial!",children:["Na instalação do Termux Server, ",e.jsx("strong",{children:"marque OpenSSH server"}),". Sem ele, você não conseguirá acessar o servidor remotamente via SSH. Se esquecer, instale depois:",e.jsx("code",{children:"pkg install openssh-server"})]}),e.jsx("h2",{children:"6. Primeiras Verificações Após Instalar"}),e.jsx(o,{title:"Verificações pós-instalação",code:`# Verificar versão do Termux instalada
lsb_release -a
...
pkg update && pkg upgrade -y`})]})}export{l as default};
