import{j as e}from"./index-BGu3owFd.js";import{P as a,I as o}from"./InfoBox-cbYNoYJG.js";import{T as s,C as t,F as r}from"./Terminal-DeUhEdrB.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return e.jsxs(a,{title:"Segurança no Termux",subtitle:"UFW, iptables, sudo hardening, SSH, atualizações automáticas, auditd, lynis, rkhunter — defesa em profundidade para Termux Desktop e Server.",difficulty:"avancado",timeToRead:"35 min",category:"Segurança",children:[e.jsx(AlertBox,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Updates"})," "," — "," ","sempre."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Firewall"})," "," — "," ","ufw/firewalld."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"SSH"})," "," — "," ","desabilite root."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"SELinux/AppArmor"})," "," — "," ","MAC."]})]}),e.jsxs("p",{children:["O Termux sai da fábrica com várias camadas de segurança ativas (AppArmor, firewall ",e.jsx("em",{children:"desligado mas presente"}),", sudo configurado, kernel hardening, ASLR, repositórios assinados com GPG). Mas ",e.jsx("strong",{children:"segurança é processo"}),", não estado: servidores expostos à internet são varridos por bots a cada poucos minutos. Esta página cobre o tripé prático ",e.jsx("strong",{children:"UFW + Fail2Ban + SSH hardening"}),", mais auditoria contínua com ",e.jsx("code",{children:"lynis"}),", ",e.jsx("code",{children:"auditd"}),", ",e.jsx("code",{children:"rkhunter"})," e a filosofia de ",e.jsx("em",{children:"least privilege"})," e ",e.jsx("em",{children:"defense in depth"}),"."]}),e.jsxs(s,{title:"wallyson@termux: ~",children:[e.jsx(t,{command:"lsb_release -a",output:`No LSB modules are available.
...
inactive
active`})]}),e.jsx("h2",{children:"1. UFW — o firewall amigável do Termux"}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"UFW (Uncomplicated Firewall)"})," é uma camada de abstração sobre o",e.jsx("code",{children:"nftables"})," (anteriormente ",e.jsx("code",{children:"iptables"}),"). Ele já vem instalado, mas",e.jsx("strong",{children:"desligado"}),". A primeira coisa em qualquer servidor é ",e.jsx("em",{children:"liberar SSH antes de habilitar"}),", sob pena de se trancar do lado de fora."]}),e.jsxs(s,{title:"root@termux: ~",path:"/etc",children:[e.jsx(t,{root:!0,command:"ufw status",output:"Status: inactive"}),e.jsx(t,{root:!0,command:"ufw default deny incoming",comment:"Política padrão: bloquear tudo que entra",output:`Default incoming policy changed to 'deny'
...
443/tcp (v6)               ALLOW IN    Anywhere (v6)`})]}),e.jsxs(o,{type:"danger",title:"ATENÇÃO: SSH primeiro, sempre",children:["Se você habilitar o UFW em uma máquina remota ",e.jsx("em",{children:"sem"})," primeiro liberar a porta SSH (22), perderá o acesso instantaneamente — e a única recuperação será via console físico ou serial do provedor (DigitalOcean, AWS, etc)."]}),e.jsx("h3",{children:"1.1 — Regras avançadas: origem, destino, faixas"}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"ufw allow from 192.168.1.0/24",comment:"Liberar TODO o tráfego vindo da rede local",output:"Rules updated"}),e.jsx(t,{root:!0,command:"ufw allow from 192.168.1.0/24 to any port 22",comment:"Permitir SSH só da rede interna (mais seguro)",output:"Rules updated"}),e.jsx(t,{root:!0,command:"ufw allow from 203.0.113.42 to any port 5432 proto tcp",comment:"Liberar PostgreSQL APENAS de um IP específico",output:"Rules updated"}),e.jsx(t,{root:!0,command:"ufw deny from 198.51.100.7",comment:"Bloquear um IP malicioso específico",output:"Rule added"}),e.jsx(t,{root:!0,command:"ufw reject 25/tcp",comment:"REJECT envia ICMP de volta (visível). DENY descarta silenciosamente.",output:`Rule added
...
Rule updated (v6)`})]}),e.jsx("h3",{children:"1.2 — Inspecionar, numerar e remover regras"}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"ufw status numbered",output:`Status: active
...
Rule deleted (v6)`})]}),e.jsx("h3",{children:"1.3 — Logs, perfis de aplicação e reset"}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"ufw logging on",output:"Logging enabled"}),e.jsx(t,{root:!0,command:"ufw logging medium",comment:"off | low (padrão) | medium | high | full",output:"Logging set to 'medium'"}),e.jsx(t,{root:!0,command:"tail -n 5 /var/log/ufw.log",output:`Nov 12 09:12:33 termux kernel: [UFW BLOCK] IN=eth0 OUT= MAC=02:7d:... SRC=185.220.101.45 DST=10.0.0.5 LEN=60 TTL=51 ID=12345 PROTO=TCP SPT=49210 DPT=23 WINDOW=29200 SYN
...
Nov 12 09:15:02 termux kernel: [UFW BLOCK] IN=eth0 OUT= SRC=222.186.30.7 DST=10.0.0.5 PROTO=TCP SPT=46011 DPT=22 WINDOW=1024 SYN`}),e.jsx(t,{root:!0,command:"ufw app list",output:`Available applications:
  Apache
  Apache Full
  Apache Secure
  CUPS
...
...`})]}),e.jsx("h2",{children:"2. iptables / nftables — quando UFW não basta"}),e.jsxs("p",{children:["UFW gera regras ",e.jsx("code",{children:"nftables"})," por baixo. Em casos avançados (NAT, marcação de pacotes, filtros L7, política por interface) você precisa editar diretamente. No Termux 24.04 o ",e.jsx("em",{children:"backend"})," padrão é ",e.jsx("code",{children:"nftables"}),", mas o comando legado",e.jsx("code",{children:"iptables"})," ainda funciona via wrapper ",e.jsx("code",{children:"iptables-nft"}),"."]}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"iptables -L -n -v --line-numbers",output:`Chain INPUT (policy DROP 0 packets, 0 bytes)
...
}`}),e.jsx(t,{root:!0,command:"iptables-save > /root/iptables.bkp",comment:"Snapshot completo das regras"})]}),e.jsxs(o,{type:"tip",title:"Use UFW para 95% dos casos",children:["Mexer em ",e.jsx("code",{children:"iptables"}),"/",e.jsx("code",{children:"nftables"})," direto é poderoso mas erra-se feio: uma regra fora de ordem destrói o ",e.jsx("em",{children:"fail-safe"}),". Reserve nftables para roteadores, gateways NAT, container hosts e firewalls de alto desempenho."]}),e.jsx("h2",{children:"3. sudo hardening"}),e.jsxs("p",{children:[e.jsx("code",{children:"sudo"})," é a porta de entrada para privilégios root. Vamos endurecê-lo: editar com ",e.jsx("code",{children:"visudo"})," (valida sintaxe), separar permissões em ",e.jsx("code",{children:"sudoers.d"}),", exigir senha, log detalhado e timeout curto."]}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"visudo",comment:"SEMPRE use visudo, nunca edite /etc/sudoers diretamente"}),e.jsx(t,{root:!0,command:"cat /etc/sudoers",output:`Defaults        env_reset
...
@includedir /etc/sudoers.d`})]}),e.jsx(r,{path:"/etc/sudoers.d/10-hardening",children:`# Endurecimento global
Defaults        env_reset
...
%dev !SHELLS`}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"visudo -cf /etc/sudoers.d/10-hardening",output:"/etc/sudoers.d/10-hardening: parsed OK"}),e.jsx(t,{command:"sudo -l",comment:"Listar o que VOCÊ pode rodar via sudo",output:`Matching Defaults entries for wallyson on termux:
...
User wallyson may run the following commands on termux:
    (ALL : ALL) ALL`}),e.jsx(t,{root:!0,command:"tail -n 5 /var/log/sudo.log",output:`Nov 12 10:02:11 : wallyson : TTY=pts/0 ; PWD=/home/wallyson ; USER=root ; COMMAND=/usr/bin/pkg update
...
MACs hmac-sha2-512-etm@openssh.com,hmac-sha2-256-etm@openssh.com`}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"sshd -t",comment:"Testar sintaxe sem reiniciar — OBRIGATÓRIO"}),e.jsx(t,{root:!0,command:"systemctl reload ssh"}),e.jsx(t,{command:"ss -tlnp | grep ssh",output:`LISTEN 0      128                *:2222             *:*    users:(("sshd",pid=1224,fd=3))
LISTEN 0      128             [::]:2222          [::]:*    users:(("sshd",pid=1224,fd=4))`})]}),e.jsxs(o,{type:"warning",title:"Mantenha duas sessões abertas",children:["Antes de aplicar mudanças no ",e.jsx("code",{children:"sshd"}),", abra uma ",e.jsx("strong",{children:"segunda sessão"}),"e teste antes de fechar a primeira. Se algo deu errado, você ainda pode corrigir."]}),e.jsx("h2",{children:"5. Atualizações automáticas — unattended-upgrades"}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"pkg install -y unattended-upgrades apt-listchanges",output:`Reading package lists... Done
...
Processing triggers for man-db (2.12.0-4build2) ...`}),e.jsx(t,{root:!0,command:"dpkg-reconfigure -plow unattended-upgrades",comment:"Pergunta se deve ativar — escolha Yes"})]}),e.jsx(r,{path:"/etc/apt/apt.conf.d/50unattended-upgrades",children:`Unattended-Upgrade::Allowed-Origins {
...
Unattended-Upgrade::SyslogEnable "true";`}),e.jsx(r,{path:"/etc/apt/apt.conf.d/20auto-upgrades",children:`APT::Periodic::Update-Package-Lists "1";
APT::Periodic::Download-Upgradeable-Packages "1";
APT::Periodic::AutocleanInterval "7";
APT::Periodic::Unattended-Upgrade "1";
APT::Periodic::Verbose "2";`}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"unattended-upgrade --dry-run -d",output:`Initial blacklist: ^linux-
...
4. 11/12/2025 09:18:05 invalid_admin 185.220.101.45 ssh /usr/sbin/sshd no 1835`})]}),e.jsx("h2",{children:"7. lynis — auditoria de configuração"}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"pkg install -y lynis",output:"Setting up lynis (3.0.9-1) ..."}),e.jsx(t,{root:!0,command:"lynis audit system",output:`[ Lynis 3.0.9 ]
...
================================================================================`})]}),e.jsx("h2",{children:"8. rkhunter & chkrootkit — caça-rootkits"}),e.jsxs(s,{title:"root@termux: ~",children:[e.jsx(t,{root:!0,command:"pkg install -y rkhunter chkrootkit"}),e.jsx(t,{root:!0,command:"rkhunter --update",output:`[ Rootkit Hunter version 1.4.6 ]
