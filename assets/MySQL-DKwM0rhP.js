import{j as a}from"./index-BGu3owFd.js";import{P as s,I as e}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function m(){return a.jsxs(s,{title:"MariaDB no Termux",subtitle:"Instalação, configuração, gerenciamento de bancos e usuários, backup e performance do MariaDB (substituto do MySQL) no Termux.",difficulty:"intermediario",timeToRead:"30 min",children:[a.jsx(e,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),a.jsx("h2",{children:"Glossário rápido"}),a.jsxs("ul",{children:[a.jsxs("li",{children:[a.jsx("strong",{children:"MariaDB"})," "," — "," ","fork popular."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"mysql_secure_installation"})," "," — "," ","setup."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"mysqldump"})," "," — "," ","backup."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"my.cnf"})," "," — "," ","config."]})]}),a.jsxs(e,{type:"warning",title:"Use 'mariadb', não 'mysql'",children:["O Termux ",a.jsxs("strong",{children:["não distribui o pacote ",a.jsx("code",{children:"mysql"})]}),". O equivalente oficial é o ",a.jsx("strong",{children:"MariaDB"})," (",a.jsx("code",{children:"pkg install mariadb"}),"), um fork 100% compatível criado pelo autor original do MySQL. O cliente ",a.jsx("code",{children:"mysql"})," e utilitários como ",a.jsx("code",{children:"mysqldump"})," vêm junto e mantêm os mesmos comandos."]}),a.jsxs("p",{children:["O ",a.jsx("strong",{children:"MariaDB"})," é um banco de dados relacional open source totalmente compatível com o MySQL. No Termux roda nativo (sem proot, sem root) e é ótimo para APIs locais, prototipagem, testes e mesmo pequenos serviços expostos na rede local."]}),a.jsxs(e,{type:"info",title:"Caveats no Android",children:["Não há ",a.jsx("code",{children:"systemd"})," no Termux — o servidor é iniciado manualmente (",a.jsx("code",{children:"mariadbd"}),") ou via runit (",a.jsx("code",{children:"sv-enable mariadb"}),"). Portas abaixo de 1024 exigem root; o MariaDB usa 3306 (livre). Os arquivos ficam em",a.jsx("code",{children:" $PREFIX/var/lib/mysql"})," e configs em ",a.jsx("code",{children:"$PREFIX/etc/my.cnf.d/"}),"."]}),a.jsx("h2",{children:"1. Instalação"}),a.jsx(o,{title:"Instalar o MariaDB no Termux",code:`# Atualizar índices e instalar
pkg update
...
# Logs
ls $PREFIX/var/lib/mysql/*.err`}),a.jsxs(e,{type:"info",title:"MariaDB = MySQL no Termux",children:["Tudo que você aprende sobre MySQL (sintaxe SQL, drivers ",a.jsx("code",{children:"mysql-connector"}),", WordPress, frameworks etc) funciona com o MariaDB. A diferença prática no Termux é só o nome do pacote (",a.jsx("code",{children:"mariadb"}),") e a ausência de ",a.jsx("code",{children:"systemctl"})," — use ",a.jsx("code",{children:"mariadbd-safe &"})," ou ",a.jsx("code",{children:"termux-services"}),"."]})]})}export{m as default};
