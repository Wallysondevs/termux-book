import{j as s}from"./index-CbmJLKV7.js";import{P as a}from"./PageContainer-C07HsLrK.js";import{C as e}from"./CodeBlock-hEuZNnwQ.js";import{I as o}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function u(){return s.jsxs(a,{title:"Timeshift — Snapshots do Sistema",subtitle:"Guia completo do Timeshift no Termux: criar, gerenciar e restaurar snapshots do sistema, agendamento automático e recuperação de desastres.",difficulty:"iniciante",timeToRead:"25 min",children:[s.jsxs("p",{children:["O ",s.jsx("strong",{children:"Timeshift"}),' é a ferramenta de restauração do sistema mais popular no Termux/Linux. Funciona como o "Restauração do Sistema" do Windows ou o Time Machine do macOS — cria snapshots do sistema que podem ser restaurados se algo der errado após uma atualização, instalação de driver ou configuração.']}),s.jsx("h2",{children:"rsync vs Btrfs — Modos de Operação"}),s.jsxs("ul",{children:[s.jsxs("li",{children:[s.jsx("strong",{children:"rsync"})," — Funciona em qualquer sistema de arquivos (ext4, xfs, etc.). Cria hard links para economizar espaço. Mais lento, mas mais compatível."]}),s.jsxs("li",{children:[s.jsx("strong",{children:"Btrfs"})," — Usa snapshots nativos do Btrfs. Quase instantâneo, não usa espaço extra até que arquivos sejam modificados (Copy-on-Write). Requer partição Btrfs."]})]}),s.jsx("h2",{children:"1. Instalar e Configurar"}),s.jsx(e,{title:"Instalar o Timeshift",code:`# Instalar o Timeshift
  ...
  sudo timeshift-gtk 2>&1`}),s.jsxs(o,{type:"info",title:"Timeshift vs Snapper",children:["Se você usa Btrfs, o ",s.jsx("strong",{children:"Snapper"})," é uma alternativa ao Timeshift com integração mais profunda ao sistema de snapshots do Btrfs. O openSUSE usa Snapper por padrão. No Termux com ext4, o Timeshift com rsync é a melhor opção."]})]})}export{u as default};
