...
pkg install -y pulseaudio`}),e.jsx("h2",{children:"2. Iniciando a sessão gráfica"}),e.jsx(o,{title:"Iniciar XFCE4 dentro do Termux:X11",code:`# 1) No Termux, inicie o servidor X11 (segura o display :0)
termux-x11 :0 &
...
# Volte para o app Termux:X11 — o XFCE4 deve aparecer.`}),e.jsxs(r,{type:"info",title:"Script único",children:["Cole o bloco abaixo num arquivo ",e.jsx("code",{children:"~/start-xfce.sh"})," e rode com",e.jsx("code",{children:"bash ~/start-xfce.sh"})," sempre que quiser abrir o desktop."]}),e.jsx(o,{title:"~/start-xfce.sh",code:`#!/data/data/com.termux/files/usr/bin/bash
...
Vol+ + N      → PageDown
Vol+ + .      → Ctrl+\\  (SIGQUIT)
Vol+ + Q ou K → mostra/esconde a barra de teclas extras`}),e.jsx(o,{title:"Atalhos com Volume Down (Vol-) — modificador Ctrl",code:`Vol- + L  → Ctrl+L (limpar tela)
Vol- + C  → Ctrl+C (interromper)
Vol- + D  → Ctrl+D (EOF / sair)
Vol- + Z  → Ctrl+Z (suspender processo)
Vol- + R  → Ctrl+R (busca reversa no histórico)`}),e.jsx("h2",{children:"Gestos na tela"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Toque longo"})," → menu de copiar/colar e tela cheia"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Pinça (zoom)"})," → aumenta/diminui o tamanho da fonte"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Deslizar com 2 dedos pra baixo"})," → mostra a barra de teclas extras"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Deslizar da esquerda"})," → abre a gaveta de sessões"]})]}),e.jsx("h2",{children:"Personalizando a barra de teclas extras"}),e.jsxs("p",{children:["A barra cinza acima do teclado é configurável. Edite o arquivo",e.jsx("code",{children:" ~/.termux/termux.properties "}),":"]}),e.jsx(o,{title:"~/.termux/termux.properties",code:`# Linha 1 = primeira fileira da barra; cada item entre vírgulas
extra-keys = [ \\
