import{j as o}from"./index-BGu3owFd.js";import{P as s,I as e}from"./InfoBox-cbYNoYJG.js";import{C as r}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function c(){return o.jsxs(s,{title:"journalctl — Logs do Sistema",subtitle:"Guia completo do journalctl no Termux: visualizar, filtrar, pesquisar e gerenciar logs do systemd, serviços, kernel e aplicações.",difficulty:"intermediario",timeToRead:"30 min",children:[o.jsx(e,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"journalctl"})," "," — "," ","journal systemd."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"-u"})," "," — "," ","por unit."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"-f"})," "," — "," ","tail."]}),o.jsxs("li",{children:[o.jsx("strong",{children:"--since"})," "," — "," ","filtra data."]})]}),o.jsxs("p",{children:["O ",o.jsx("strong",{children:"journalctl"})," é a ferramenta para acessar os logs do systemd journal, o sistema centralizado de logs do Termux. Ele captura logs do kernel, serviços systemd, aplicações e mensagens do sistema em um formato estruturado e indexado, permitindo buscas rápidas e filtros poderosos."]}),o.jsx("h2",{children:"1. Visualizar Logs"}),o.jsx(r,{title:"Comandos básicos do journalctl",code:`# Ver todos os logs (do mais antigo ao mais recente)
  journalctl
