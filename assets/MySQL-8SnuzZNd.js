import{j as a}from"./index-CbmJLKV7.js";import{P as e}from"./PageContainer-C07HsLrK.js";import{C as o}from"./CodeBlock-hEuZNnwQ.js";import{I as s}from"./InfoBox-OReRpdzk.js";import"./house-Cv6RfdLC.js";import"./proxy-BQXFYY1E.js";function m(){return a.jsxs(e,{title:"MySQL / MariaDB no Termux",subtitle:"Instalação, configuração, gerenciamento de bancos e usuários, backup, segurança, replicação e performance do MySQL/MariaDB.",difficulty:"intermediario",timeToRead:"30 min",children:[a.jsxs("p",{children:["O ",a.jsx("strong",{children:"MySQL"})," é o banco de dados relacional open source mais popular do mundo, usado por WordPress, Facebook, Twitter e milhões de aplicações web. O ",a.jsx("strong",{children:"MariaDB"}),"é um fork compatível criado pelo fundador original do MySQL, com melhorias de performance e recursos extras. No Termux, ambos funcionam de forma quase idêntica."]}),a.jsx("h2",{children:"1. Instalação"}),a.jsx(o,{title:"Instalar MySQL ou MariaDB",code:`# === MySQL ===
  pkg update
  ...
  # 5. Recarregar tabelas de privilégios → Y`}),a.jsx("h2",{children:"2. Acessar e Gerenciar"}),a.jsx(o,{title:"Comandos básicos do MySQL",code:`# Acessar como root (no Termux, usa auth_socket por padrão)
  sudo mysql
  # Ou com senha:
  mysql -u root -p
  ...
  SELECT * FROM posts WHERE MATCH(titulo, conteudo) AGAINST('termux' IN BOOLEAN MODE);`}),a.jsx("h2",{children:"4. Configuração"}),a.jsx(o,{title:"Configurar MySQL para performance e segurança",code:`# Arquivo de configuração
