import{j as a}from"./index-BGu3owFd.js";import{P as e,I as o}from"./InfoBox-cbYNoYJG.js";import{C as r}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return a.jsxs(e,{title:"Visualizando Arquivos e Logs",subtitle:"cat, less, head, tail, grep, wc — lendo, filtrando e analisando conteúdo de arquivos de forma eficiente.",difficulty:"iniciante",timeToRead:"15 min",children:[a.jsx(o,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),a.jsx("h2",{children:"Glossário rápido"}),a.jsxs("ul",{children:[a.jsxs("li",{children:[a.jsx("strong",{children:"cat/less"})," "," — "," ","clássicos."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"bat"})," "," — "," ","com syntax."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"head/tail"})," "," — "," ","início/fim."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"glow"})," "," — "," ","markdown."]})]}),a.jsx("p",{children:"Saber ler e filtrar conteúdo de arquivos é fundamental no Linux — especialmente para analisar logs, verificar configurações e processar dados. Esses comandos são suas ferramentas de leitura e inspeção do dia a dia."}),a.jsx("h2",{children:"cat — Mostrar Conteúdo de Arquivos"}),a.jsx(r,{title:"cat: concatenar e exibir arquivos",code:`# Exibir o conteúdo de um arquivo na tela
cat arquivo.txt
...
# >> = append (adicionar ao fim, sem apagar o que já existe)`}),a.jsx("h2",{children:"less — Navegação em Arquivos Longos"}),a.jsx(r,{title:"less: ler arquivos sem travamento",code:`# Abrir arquivo com paginação (essencial para arquivos longos!)
less /var/log/syslog
...
less -N arquivo.txt`}),a.jsx("h2",{children:"head e tail — Começo e Fim de Arquivos"}),a.jsx(r,{title:"head e tail: ver partes do arquivo",code:`# head: ver as primeiras linhas de um arquivo
...
echo "=== FIM ===" && tail -n 5 arquivo.txt`}),a.jsx("h2",{children:"grep — Filtrar Linhas por Padrão"}),a.jsx(r,{title:"grep: seu melhor amigo para analisar logs",code:`# Buscar uma palavra em um arquivo
...
# O | passa a saída do grep para o tail, que mostra apenas as últimas 20`}),a.jsx("h2",{children:"wc — Contar Linhas, Palavras e Bytes"}),a.jsx(r,{title:"wc: word count (contador)",code:`# wc = word count (contagem de palavras)
...
ls /var/log | wc -l`}),a.jsx("h2",{children:"sort e uniq — Ordenar e Deduplicar"}),a.jsx(r,{title:"sort e uniq: organizando dados",code:`# sort: ordenar linhas de um arquivo
...
grep "Failed password" /var/log/auth.log | \\
    ...
    # -n = numérico
    head -10   # Top 10 IPs mais frequentes`}),a.jsx("h2",{children:"Lendo Logs Importantes do Termux"}),a.jsx(r,{title:"Os logs mais úteis do dia a dia",code:`# Log geral do sistema (tudo que acontece no Termux)
tail -f /var/log/syslog
...
journalctl -u nginx -f  # -u = unit: logs de um serviço específico`})]})}export{d as default};
