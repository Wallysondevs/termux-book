import{j as e}from"./index-BGu3owFd.js";import{P as s,I as r}from"./InfoBox-cbYNoYJG.js";import{C as o}from"./CodeBlock-D4kWtW6Y.js";import"./house-BlvEJiKe.js";import"./proxy-C2ahmsHM.js";function d(){return e.jsxs(s,{title:"Troubleshooting Termux",subtitle:"Diagnosticando e resolvendo problemas comuns — boot, rede, espaço em disco, pacotes corrompidos e muito mais.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsx(r,{type:"info",title:"Pré-requisitos",children:'Ler "Primeiros Passos" e ter terminal Linux/Termux disponível.'}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"journalctl -xe"})," "," — "," ","últimos erros."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"dmesg"})," "," — "," ","kernel."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"systemctl status"})," "," — "," ","unit health."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"rescue"})," "," — "," ","modo recuperação."]})]}),e.jsx("p",{children:"Todo sistema Linux vai apresentar problemas em algum momento. A habilidade de diagnosticar e resolver esses problemas é o que separa um usuário experiente de um iniciante. Este guia cobre os problemas mais comuns no Termux e como resolvê-los."}),e.jsx("h2",{children:"Problemas com APT e Pacotes"}),e.jsx("h3",{children:"apt está travado ou corrompido"}),e.jsx(o,{title:"Corrigir APT quebrado",code:`# Problema 1: "Could not get lock /var/lib/dpkg/lock"
# Outro processo apt está rodando
sudo killall apt pkg    # Matar instâncias em execução
...
pkg install -f           # Corrigir automaticamente
pkg autoclean           # Remover pacotes conflitantes
...
sudo add-apt-repository --remove ppa:nome/ppa`}),e.jsx("h2",{children:"Problemas de Boot"}),e.jsx(o,{title:"O sistema não inicia",code:`# Se o GRUB aparece mas o Termux não inicia:

# 1. No menu do GRUB, selecione "Advanced options for Termux"
...
# No menu GRUB → "Termux, com Linux X.X.X-X-generic (recovery mode)"
...
# Reinstalar o kernel:
pkg install --reinstall linux-generic
update-grub

# Se o GRUB não aparece mais:
# Boot pelo live USB do Termux
# Em "Try Termux":
...
# === LIMPEZA DO APT ===
pkg autoclean -y     # Remover pacotes desnecessários
pkg autoclean         # Limpar cache de versões antigas
pkg clean             # Limpar TODO o cache de pacotes
...
pkg install --reinstall bcmwl-kernel-source
sudo modprobe wl
...
sensors
pkg install s-tui     # Monitor de temperatura gráfico
...
# Ver log do Termux após um crash:
ls /var/crash/
...
# Habilitar:
echo 1 | sudo tee /proc/sys/kernel/sysrq`})]})}export{d as default};
